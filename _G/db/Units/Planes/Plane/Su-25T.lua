_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	DamageParts = { "SU-25T-WING-R", "SU-25T-WING-L", "SU-25T-NOSE", "SU-25T-TAIL" },
	DefaultTask = <1>{
		Name = "CAS",
		OldID = "CAS",
		WorldID = 31
	...
	H_max = 10000,
	HumanCockpit = true,
	HumanCockpitPath = "./Mods/aircraft/Su-25T/Cockpit/Scripts/",
	HumanCockpitPlugins = { {
	...
	HumanCommPanelPath = "./Mods/aircraft/Su-25T/comm.lua",
	HumanRadio = {
		frequency = 124,
		modulation = 0
	},
	...
	SFM_Data = {
		aerodynamics = {
			...
			kjx = 2.25,
			kjz = 0.00125,
			table_data = { { 0, 0.025, 0.0817, 0.052, 0.017, 0.5, 20, 1.21 }, { 0.4, 0.025, 0.0817, 0.052, 0.017, 3.5, 20, 1.21 }, { 0.6, 0.0272, 0.0872, 0.048, 0.03, 3.5, 20, 1.26 }, { 0.8, 0.048, 0.0816, 0.13, 0.14, 3.5, 20, 0.755 }, { 0.9, 0.0741, 0.08, 0.212, 0.25, 3.5, 20, 0.6 }, { 1.5, 0.0741, 0.08, 0.212, 0.25, 3.5, 20, 0.6 } }
		},
		engine = {
			ForsRUD = 1,
			MaksRUD = 1,
	...
	_file = "Scripts/Database/planes\\Su-25T.lua",
	_file_flyable = "./Mods/aircraft/Su-25T/entry.lua",
	_origin_flyable = "Su-25T by Eagle Dynamics",
