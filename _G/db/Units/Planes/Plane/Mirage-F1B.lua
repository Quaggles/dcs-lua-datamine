_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	Pylons = { {
			Launchers = { {
					...
					CLSID = "{R550_Magic_1}",
					arg_value = 0.15,
					attach_point_position = <2>{ -0.1, -0.09, 0 }
				}, {
					CLSID = "{FC23864E-3B80-48E3-9C03-4DA8B1D7497B}",
					arg_value = 0.15,
					attach_point_position = <3>{ -0.1, -0.09, 0 }
				} },
			Number = 1,
			Order = 1,
			Type = 0,
			...
			Launchers = { {
					...
					CLSID = "{S530F}",
					arg_value = 0.25,
					attach_point_position = <4>{ 0.33, -0.1, 0 },
					forbidden = { {
							loadout = { "{S530F}" },
							station = 4
						}, {
	...
	has_speedbrake = true,
	height = 4.5,
	input_profile_entry = "Mirage-F1B",
	is_tanker = false,
	length = 15.3,
	lights_data = {
		lights = {
