_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	Guns = { {
			_file = "./CoreMods/aircraft/Mirage-F1/Mirage-F1C-200.lua",
	...
	SFM_Data = {
		aerodynamics = {
			...
			kjx = 2.85,
			kjz = 0.00125,
			table_data = { { 0, 0.0191, 0.0625, 0.22, 0.0001, 0.5, 25, 2 }, { 0.1, 0.0191, 0.0625, 0.22, 0.0001, 0.5, 25, 2 }, { 0.2, 0.0191, 0.0625, 0.22, 0.0001, 1.5, 25, 2 }, { 0.23, 0.0191, 0.0625, 0.22, 0.0001, 1.5, 25, 2 }, { 0.4, 0.0191, 0.07, 0.22, 0.0001, 2.5, 24, 2 }, { 0.6, 0.0191, 0.072, 0.22, 0.0001, 3.5, 22, 2 }, { 0.7, 0.0193, 0.071, 0.22, 0.0001, 3.5, 21, 1.71 }, { 0.8, 0.0195, 0.071, 0.22, 0.0001, 3.5, 17, 1.5 }, { 0.9, 0.0198, 0.071, 0.222, 0.0001, 3.5, 17, 1.25 }, { 1, 0.0354, 0.076, 0.225, 0.0001, 3.5, 17, 0.99 }, { 1.05, 0.038, 0.07, 0.2275, 0.0001, 3.5, 17, 0.94 }, { 1.1, 0.038, 0.064, 0.23, 0.0001, 3.15, 17, 0.91 }, { 1.2, 0.037, 0.065, 0.27, 0.0001, 2.45, 17, 0.74 }, { 1.3, 0.036, 0.065, 0.29, 0.0001, 1.75, 16, 0.62 }, { 1.5, 0.038, 0.065, 0.35, 0.0001, 1.5, 13, 0.487 }, { 1.6, 0.036, 0.06, 0.398, 0.0001, 0.9, 12, 0.445 }, { 1.8, 0.0344, 0.052, 0.422, 0.0001, 0.86, 11.4, 0.385 }, { 2, 0.0324, 0.042, 0.43, 9.9999999999999e-06, 0.78, 10.2, 0.33 }, { 2.2, 0.032, 0.034, 0.43, 1e-05, 0.7, 9, 0.3 }, { 2.3, 0.031, 0.028, 0.5, 1e-05, 0.7, 9, 0.225 }, { 2.5, 0.0298, 0.025, 0.5, 1e-05, 0.7, 9, 0.225 } }
		},
		engine = {
			ForsRUD = 0.91,
			MaksRUD = 0.85,
	...
	has_speedbrake = true,
	height = 4.5,
	input_profile_entry = "Mirage-F1C-200",
	is_tanker = false,
	length = 15.3,
	lights_data = {
		lights = { {
