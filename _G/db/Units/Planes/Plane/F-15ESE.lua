_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	Damage = { {
		...
		cell_indices = {
			AIR_BRAKE_R = 20,
			BOTTOM_LEFT_ENGINE = 137,
			BOTTOM_RIGHT_ENGINE = 138,
			CABIN_LEFT_SIDE = 4,
			CABIN_RIGHT_SIDE = 5,
			COCKPIT = 3,
			CREW_1 = 90,
			...
			TAIL_LEFT_SIDE = 56,
			TAIL_RIGHT_SIDE = 57,
			TOP_CENTER_LEFT_ENGINE = 142,
			TOP_CENTER_RIGHT_ENGINE = 143,
			WHEEL_F = 83,
			WHEEL_L = 84,
			WHEEL_R = 85,
			WING_L_CENTER = 29,
	...
	HumanFM = { "F-15E by RAZBAM", "F15E_FM",
		...
		suspension = { {
				...
				amortizer_basic_length = 0.4191,
				amortizer_direct_damper_force_factor = 40000,
				amortizer_max_length = 0.4191,
				amortizer_min_length = 0,
				amortizer_reduce_length = 0.002,
				amortizer_spring_force_factor = 6200000,
				amortizer_spring_force_factor_rate = 4,
				amortizer_static_force = 8900,
