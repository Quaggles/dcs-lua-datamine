_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	Damage = {
		...
		[29] = {
			args = { 214 },
			critical_damage = 5,
			deps_cells = { 137, 138, 35 }
		},
		[30] = {
			args = { 214 },
			critical_damage = 5,
			deps_cells = { 140, 141, 36 }
		},
		[35] = {
			args = { 223 },
			critical_damage = 5,
		...
		cell_indices = {
			...
			RUDDER = 53,
			RUDDER_R = 54,
			STABILIZATOR_L_IN = 145,
			STABILIZATOR_R_IN = 146,
			TAIL_BOTTOM = 58,
			TAIL_TOP = 100,
			WING_L_CENTER = 29,
			WING_L_IN = 35,
	...
	attribute = { 1, 1, 6, "Redacted", "Battleplanes", "UAVs", "All", "NonAndLightArmoredUnits", "NonArmoredUnits", "Air", "Planes", "Battle airplanes" },
