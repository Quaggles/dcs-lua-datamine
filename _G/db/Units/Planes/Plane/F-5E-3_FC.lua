_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	DamageParts = { "f-5e3_fc_oblomok_wing_r", "f-5e3_fc_oblomok_wing_l" },
	DefaultTask = <1>{
		Name = "CAP",
		OldID = "CAP",
		WorldID = 11
	...
	WingSpan = 8.53,
	WorldID = 331,
	_file = "./CoreMods/aircraft/F-5E/F-5E-3_FC.lua",
	...
	shape_table_data = { {
			...
			classname = "lLandPlane",
			file = "f-5e3_fc_oblomok",
			fire = { 240, 2 },
			name = "F-5E-3_FC_destr",
			positioning = "BYNORMAL"
		} },
	stores_number = 7,
	swapped_names = true,
