_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	H_max = 15240,
	HumanCockpit = true,
	HumanCockpitPath = "./Mods/aircraft/Mirage-F1/Cockpit/Mirage-F1/Mirage-F1BE/",
	HumanCockpitPlugins = { {
	...
	ViewSettings = {
		...
		Cockpit = { {
				...
				CockpitLocalPoint = { 3.437, 0.368, 0 },
				EyePoint = { 0.05, 0.1, 0 },
				ShoulderSize = 0.25,
				limits_6DOF = {
					roll = 90,
				...
				CameraAngleRestriction = { false, 90, 0.5 },
				CameraViewAngleLimits = { 20, 140 },
				CockpitLocalPoint = { 1.88, 0.632, 0 },
				EyePoint = { 0.05, 0.1, 0 },
				ShoulderSize = 0.25,
				limits_6DOF = {
					roll = 90,
	...
	has_speedbrake = true,
	height = 4.5,
	input_profile_entry = "Mirage-F1BE",
	is_tanker = false,
	length = 15.3,
	lights_data = {
		lights = {
