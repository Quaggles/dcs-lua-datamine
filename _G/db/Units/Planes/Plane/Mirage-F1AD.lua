_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	Guns = { {
			_file = "./CoreMods/aircraft/Mirage-F1/Mirage-F1AD.lua",
	...
	_file = "./CoreMods/aircraft/Mirage-F1/Mirage-F1AD.lua",
	_origin = "Mirage F1 Assets by Aerges",
	air_refuel_receptacle_pos = { 6.002, 0.429, 0.096 },
	...
	has_speedbrake = true,
	height = 4.5,
	input_profile_entry = "Mirage-F1AD",
	is_tanker = false,
	length = 15.3,
	lights_data = {
		lights = {
