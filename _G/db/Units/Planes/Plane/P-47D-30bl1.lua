_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	Damage = { {
		...
		[35] = {
			...
			damage_boundary = 0.1,
			droppable = true,
			failures = { { "INST_PITOT_DAMAGE", 0.005 }, { "FUEL_BOOSTER_FUEL_PUMP_2_DEGRADED", 0.22 } },
			innards = { {
					count = 2,
					durability = 3,
					id = "XSparWLHIn",
		...
		[36] = {
			...
			damage_boundary = 0.1,
			droppable = true,
			failures = { { "FUEL_BOOSTER_FUEL_PUMP_2_DEGRADED", 0.22 } },
			innards = { {
					count = 2,
					durability = 3,
					id = "XSparWRHIn",
	...
	main_gear_pos = { -0.254, -2.37, 2.395 },
