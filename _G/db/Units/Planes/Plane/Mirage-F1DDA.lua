_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	WingSpan = 8.4,
	WorldID = 323,
	_file = "./CoreMods/aircraft/Mirage-F1/Mirage-F1DDA.lua",
	...
	has_speedbrake = true,
	height = 4.5,
	input_profile_entry = "Mirage-F1DDA",
	is_tanker = false,
	length = 15.3,
	lights_data = {
		lights = {
