_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	HumanFM = { "F-16C bl.50", "F16C",
		...
		debugLine = "{M}:%1.3f {KCAS}:%4.1f {KEAS}:%4.1f {KTAS}:%4.1f {Mind}:%1.3f {IndAS}:%4.1f {AoA}:%4.1f {AoS}:%4.1f {nx}:%2.1f {ny}:%4.1f {nz}:%5.2f {wx}:%4.1f {wy}:%4.1f {wz}:%4.1f {Fx}:%7.0f {Pl}:%7.0f {mass}:%4.1f {X}:%2.2f {Lstab}:%2.1f {Lail}:%2.1f {Rud}:%2.1f {pitch}:%2.1f {Vy}:%7.1f",
	...
	Pylons = { {
			...
			DisplayName = "6",
			Launchers = { <table 48>, <table 49>, <table 50>, <table 51>, <table 52>, <table 53>, <table 54>, <table 55>, <table 56>, <table 57>, <table 58>, <table 59>, <table 60>, <table 61>, <table 62>, <table 63>, <table 64>, <table 65>, <table 66>, <table 67>, <table 68>, <table 69>, <table 70>, {
