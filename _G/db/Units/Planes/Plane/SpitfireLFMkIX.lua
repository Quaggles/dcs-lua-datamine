_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	Guns = { {
			...
			supply = {
				...
				mixes = { { 6, 2, 2, 4, 1 }, { 6, 2, 2, 4, 1 }, { 6, 3, 3, 3, 3 }, { 1, 2, 2, 4, 1 }, { 5, 2, 2, 4, 1 }, { 6, 1, 1, 1, 1, 1, 1 } },
				shells = { <2>{
						AP_cap_caliber = 20,
						Da0 = 0.0006,
						Da1 = 0,
			...
			supply = {
				...
				mixes = { { 1, 6, 2, 2, 4 }, { 1, 6, 2, 2, 4 }, { 3, 6, 3, 3, 3 }, { 1, 1, 2, 2, 4 }, { 1, 5, 2, 2, 4 }, { 1, 1, 1, 6, 1, 1, 1 } },
			...
			supply = {
				...
				mixes = { { 14, 3, 3, 3, 3 }, { 14, 11, 11, 11, 11 }, { 14, 3, 3, 3, 3 }, { 3 }, { 3 }, { 14, 1 } },
				shells = { <14>{
						AP_cap_caliber = 7.62,
						Da0 = 0.00045,
						Da1 = 0,
			...
			supply = {
				...
				mixes = { { 13, 8, 13, 13, 13 }, { 13, 8, 13, 13, 13 }, { 11, 6, 11, 11, 11 }, { 13 }, { 13, 9, 13, 13, 13 }, { 8 } },
			...
			supply = {
				...
				mixes = { { 11, 11, 14, 11, 11 }, { 11, 11, 14, 11, 11 }, { 11, 11, 6, 11, 11 }, { 3 }, { 11 }, { 1, 14 } },
				shells = { <table 14>, <table 16>, <table 18>, <table 20>, <table 22>, <table 24>, <table 26>, <table 28>, <table 30>, <table 32>, <table 34>, <table 36>, <table 38>, <table 40> }
			},
			supply_position = { -0.22, -0.368, 3.432 }
		}, {
			...
			supply = {
				...
				mixes = { { 13, 13, 13, 8, 13 }, { 13, 13, 13, 8, 13 }, { 11, 11, 11, 6, 11 }, { 13 }, { 13, 13, 13, 9, 13 }, { 8 } },
				shells = { <table 14>, <table 16>, <table 18>, <table 20>, <table 22>, <table 24>, <table 26>, <table 28>, <table 30>, <table 32>, <table 34>, <table 36>, <table 38>, <table 40> }
			},
			supply_position = { -0.392, -0.368, 3.432 }
		} },
	...
	_file = "./CoreMods/WWII Units/SpitfireLFMkIX/SpitfireLFMkIX.lua",
	_origin = "World War II AI Units by Eagle Dynamics",
	ammo_type = { "CM Combat Mix", "HE Anti-Bomber", "AG Ground Attack", "CS No Tracers", "NO Night Time Tracers", "TP Target Practice" },
