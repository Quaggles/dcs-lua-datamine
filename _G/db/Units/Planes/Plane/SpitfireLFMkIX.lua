_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	_file = "./CoreMods/WWII Units/SpitfireLFMkIX/SpitfireLFMkIX.lua",
	_origin = "World War II AI Units by Eagle Dynamics",
	ammo_type = { "APIT AP/De Wilde (Tracer) - 20mm HEI/SAPI", "BaIT Ball/De Wilde (Tracer) - 20mm HEI/SAPI", "API AP/De Wilde (No Tracer) - 20mm HEI/SAP", "BaI Ball/De Wilde (No Tracer) - 20mm HEI/SAPI", "TP Target Practice" },
