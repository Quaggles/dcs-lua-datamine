_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	attribute = { 1, 1, 1, "Redacted", "Bombers", "Datalink", "Link16", "All", "NonAndLightArmoredUnits", "NonArmoredUnits", "Air", "Planes", "Battle airplanes" },
		...
		lights = {
			[2] = {
				lights = { {
						...
						position = <6>{ 4.02, -1.291, 0 },
						typename = "spotlight"
					}, {
						argument = 208,
						color = { 255, 255, 200, 0.333 },
						connector = "RESERV_SPOT_PTR",
						position = <7>{ 0.409, -0.708, 0.864 },
						typename = "spotlight"
					}, {
						argument = 208,
						color = { 255, 255, 200, 0.333 },
						connector = "FARA_3",
						position = <8>{ 0.409, -0.708, -0.864 },
						typename = "spotlight"
					} },
				typename = "collection"
			},
