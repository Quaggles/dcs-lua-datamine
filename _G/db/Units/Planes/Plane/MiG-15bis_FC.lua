_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	DamageParts = { "MiG_15bis_FC_oblomok__wing_R", "MiG_15bis_FC_oblomok__wing_L" },
	DefaultTask = <1>{
		Name = "CAP",
		OldID = "CAP",
		WorldID = 11
	},
	DisplayName = "MiG-15bis FC",
	EmptyWeight = 3753,
	Failures = { {
			enable = false,
			hh = 0,
	...
	Guns = { {
			_file = "./CoreMods/aircraft/MiG-15bis/MiG-15bis_FC.lua",
