_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	SFM_Data = {
		...
		engine = {
			...
			dpdh_m = 8700,
			hMaxEng = 19,
			table_data = { { 0, 112700, 174440 }, { 0.2, 117600, 176400 }, { 0.4, 117600, 193060 }, { 0.6, 122500, 225400 }, { 0.7, 122500, 230000 }, { 0.8, 132000, 233000 }, { 0.9, 135000, 236000 }, { 1, 132000, 245000 }, { 1.1, 124000, 246000 }, { 1.2, 120000, 248000 }, { 1.3, 115000, 253000 }, { 1.5, 104000, 262000 }, { 1.8, 97000, 295000 }, { 2, 99000, 320000 }, { 2.2, 104000, 355000 }, { 2.515, 100000, 425000 }, { 3, 127400, 435000 } },
			type = "TurboJet"
		}
	},
	Sensors = {
	...
	WingSpan = "14",
	WorldID = 24,
	_file = "Scripts/Database/planes\\MiG-25PD.lua",
	attribute = { 1, 1, 3, "Redacted", "Interceptors", "All", "NonAndLightArmoredUnits", "NonArmoredUnits", "Air", "Planes", "Battle airplanes" },
