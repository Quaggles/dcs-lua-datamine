_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	SFM_Data = {
		aerodynamics = {
			...
			kjx = 2.7,
			kjz = 0.01,
			table_data = { { 0, 0.0197, 0.044, 0.18, 0.2, 0, 16.6, 0.8 }, { 0.2, 0.0197, 0.044, 0.18, 0.2, 1.5, 16.6, 0.8 }, { 0.4, 0.0197, 0.044, 0.18, 0.2, 1.5, 16.6, 0.8 }, { 0.6, 0.0197, 0.044, 0.18, 0.2, 1.5, 16.6, 0.8 }, { 0.7, 0.0197, 0.044, 0.18, 0.2, 1.5, 16.6, 0.8 }, { 0.8, 0.0197, 0.046, 0.17, 0.2, 1.5, 16.6, 0.83 }, { 0.9, 0.02, 0.05, 0.17, 0.2, 1.5, 16.6, 0.87 }, { 1, 0.0368, 0.05, 0.22, 0.2, 1.5, 11, 0.51 }, { 1.1, 0.0376, 0.048, 0.2, 0.2, 1.5, 9, 0.32 }, { 1.2, 0.0361, 0.045, 0.22, 0.2, 1.5, 8, 0.28 }, { 1.3, 0.0332, 0.042, 0.24, 0.2, 1.5, 8, 0.26 }, { 1.5, 0.029, 0.037, 0.28, 0.2, 1.5, 8, 0.24 }, { 1.8, 0.0276, 0.031, 0.32, 0.2, 1.5, 8, 0.24 }, { 2, 0.027, 0.029, 0.38, 0.28, 1.5, 8, 0.24 }, { 2.2, 0.027, 0.026, 0.44, 0.3, 1.5, 8, 0.23 }, { 2.5, 0.0268, 0.022, 0.5, 0.32, 1.5, 5.25, 0.22 }, { 3.9, 0.027, 0.018, 0.56, 0.4, 1.5, 5, 0.2 } }
		},
		engine = {
			ForsRUD = 0.91,
			MaksRUD = 0.85,
			...
			dpdh_m = 2700,
			hMaxEng = 19.5,
			table_data = { { 0, 40800, 64000 }, { 0.2, 36000, 58400 }, { 0.4, 32000, 56500 }, { 0.6, 34000, 64700 }, { 0.7, 35200, 70000 }, { 0.8, 36000, 73500 }, { 0.9, 38000, 78500 }, { 1, 39000, 81700 }, { 1.1, 41500, 85400 }, { 1.2, 36000, 88600 }, { 1.3, 28000, 90000 }, { 1.5, 17600, 94000 }, { 1.8, 10700, 106398 }, { 2, 9400, 111331 }, { 2.2, 5700, 112500 }, { 2.5, 5700, 123300 }, { 3.9, 5700, 74744 } },
			typeng = 1
		}
	},
	Sensors = {
