_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	HumanFM = { "MiG-21Bis by Magnitude 3 LLC", "FlightModel",
		...
		suspension = { {
				...
				amortizer_back_damper_force_factor = 9794.3,
				amortizer_basic_length = 0.12,
				amortizer_direct_damper_force_factor = 10882.6,
				amortizer_max_length = 0.12,
				amortizer_min_length = 0,
				amortizer_reduce_length = 0.09,
				amortizer_spring_force_factor = 9214860000,
				amortizer_spring_force_factor_rate = 6,
				amortizer_static_force = 14691.5,
				...
				yaw_limit = 0.69813170079773
			}, {
				allowable_hard_contact_length = 0.3,
				amortizer_back_damper_force_factor = 19282.5,
				amortizer_basic_length = 0.16,
				amortizer_direct_damper_force_factor = 21425,
				amortizer_max_length = 0.16,
				amortizer_min_length = 0,
				amortizer_reduce_length = 0.12,
				amortizer_spring_force_factor = 2491390000000,
				amortizer_spring_force_factor_rate = 9,
				amortizer_static_force = 38565.1,
				anti_skid_installed = true,
				arg_amortizer = 6,
				arg_post = 5,
