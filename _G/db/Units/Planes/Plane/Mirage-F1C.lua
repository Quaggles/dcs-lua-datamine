_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	Pylons = { {
			Launchers = { {
					...
					CLSID = "{R550_Magic_1}",
					arg_value = 0.15,
					attach_point_position = <4>{ -0.1, -0.09, 0 }
				}, {
					CLSID = "{FC23864E-3B80-48E3-9C03-4DA8B1D7497B}",
					arg_value = 0.15,
					attach_point_position = <5>{ -0.1, -0.09, 0 }
				} },
			Number = 1,
			Order = 1,
			Type = 0,
			...
			Launchers = { {
					...
					CLSID = "{S530F}",
					arg_value = 0.25,
					attach_point_position = <6>{ 0.33, -0.1, 0 },
					forbidden = { {
							loadout = { "{S530F}" },
							station = 4
						}, {
	...
	net_animation = { 11, 12, 13, 14, 15, 16, 18, 23, 28, 35, 36, 37, 38, 75, 86, 90, 115, 116, 117, 120, 123, 126, 127, 128, 129, 149, 182, 184, 282, 283, 284, 285, 308, 309, 310, 311, 312, 313, 314, 338, 339, 340, 341, 427, 705, 750, 751, 752, 753, 754, 755, 780, 781, 782, 803, 845, 905, 911, 920, 924, 925, 926, 928, 929 },
