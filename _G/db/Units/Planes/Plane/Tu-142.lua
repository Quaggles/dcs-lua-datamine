_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	DamageParts = { "TU-142-OBLOMOK-WING-R", "TU-142-OBLOMOK-WING-L" },
	DefaultTask = <1>{
	...
	WingSpan = "50.04",
	WorldID = 22,
	_file = "Scripts/Database/planes\\Tu-142.lua",
