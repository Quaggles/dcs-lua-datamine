_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	SFM_Data = {
		aerodynamics = {
			...
			table_data = { { 0, 0.024, 0.064, 0.075, 0.12, 0.2, 25, 1.2 }, { 0.2, 0.024, 0.064, 0.075, 0.12, 0.8, 25, 1.2 }, { 0.4, 0.024, 0.0678, 0.075, 0.12, 1.8, 25, 1.2 }, { 0.6, 0.0239, 0.0716, 0.075, 0.12, 2.5, 25, 1.2 }, { 0.7, 0.024, 0.0757, 0.075, 0.12, 2.634, 25, 1.18 }, { 0.8, 0.0235, 0.0798, 0.075, 0.12, 2.5, 25, 1.16 }, { 0.9, 0.025, 0.0862, 0.075, 0.125, 1.9, 12.5, 1.14 }, { 1, 0.044, 0.0978, 0.14, 0.1, 1.43, 12.5, 1.12 }, { 1.05, 0.0465, 0.105, 0.1775, 0.125, 1.047, 12.5, 1.11 }, { 1.1, 0.049, 0.102, 0.215, 0.15, 0.9, 12.5, 1.1 }, { 1.2, 0.049, 0.0974, 0.228, 0.17, 0.8, 12.5, 1.05 }, { 1.3, 0.049, 0.089, 0.237, 0.2, 0.7, 12.5, 1 }, { 1.5, 0.0475, 0.0692, 0.251, 0.2, 0.7, 12.5, 0.9 }, { 1.7, 0.045166666666667, 0.06, 0.24366666666667, 0.32, 0.7, 12.5, 0.7 }, { 1.8, 0.044, 0.058, 0.24, 0.38, 0.7, 12.5, 0.64 }, { 2, 0.043, 0.052, 0.222, 2.5, 0.7, 12.5, 0.52 }, { 2.2, 0.041, 0.049, 0.227, 3.2, 0.7, 12.5, 0.4 }, { 2.5, 0.04, 0.043, 0.25, 4.5, 0.7, 12.5, 0.4 }, { 3.9, 0.035, 0.033, 0.35, 6, 0.7, 12.5, 0.4 } }
		},
		engine = {
			ForsRUD = 0.91,
			MaksRUD = 0.85,
