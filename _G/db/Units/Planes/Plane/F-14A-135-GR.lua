_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	Damage = {
		...
		cell_indices = {
			...
			AVX_ECS = 115,
			AVX_GTS = 116,
			AVX_WALL_LEFT_FRONT = 117,
			AVX_WALL_LEFT_REAR = 118,
			AVX_WALL_RIGHT_FRONT = 119,
			AVX_WALL_RIGHT_REAR = 120,
			CABIN_LEFT_SIDE = 4,
			CABIN_RIGHT_SIDE = 5,
			COUNTERMEASURES = 121,
			CREW_1 = 90,
			...
			DASHBOARD_RIO = 123,
			ECM_DUCKTAIL = 124,
			EJECTION_SEAT_PILOT = 125,
			EJECTION_SEAT_RIO = 126,
			ELEVATOR_L = 51,
			ELEVATOR_R = 52,
			ENGINE_L = 11,
			ENGINE_L_INTAKE = 127,
			...
			WINGBOX_LEFT = 158,
			WINGBOX_RIGHT = 159,
			WING_FUEL_TANK_L = 160,
			WING_FUEL_TANK_R = 161,
			WING_L = 35,
			WING_R = 36
		}
	},
	...
	crew_members = { {
			...
			drop_canopy_name = 291,
			ejection_added_speed = { -3, 15, -3 },
			ejection_order = 2,
			ejection_seat_name = 290,
			g_suit = 2,
			pos = { 4, 0.65, 0 },
			role = "pilot",
