_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	H_max = 18300,
	HumanCockpit = true,
	HumanCockpitPath = "./Mods/aircraft/F-15C/Cockpit/KneeboardRight/",
	HumanCockpitPlugins = { {
	...
	HumanCommPanelPath = "./Mods/aircraft/F-15C/Comm/F-15C.lua",
	HumanFM = { "F-15C", "F15",
		center_of_mass = { -0.172, -0.6, 0 },
		config_path = "./Mods/aircraft/F-15C/FM/F15/config.lua",
	...
	_file_flyable = "./Mods/aircraft/F-15C/entry.lua",
	_origin_flyable = "F-15C",
