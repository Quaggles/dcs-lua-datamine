_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = { { { -1.36, -0.185, 0 }, { -0.595, 0.294, 2.66 }, { -1.743, 0.234, -3.769 }, { -0.82, 0.265, 2.774 }, { -0.82, 0.265, -2.774 }, { -0.82, 0.255, 4.274 }, { -0.82, 0.255, -4.274 }, { -4.471, -0.059, 0.91 }, { -4.471, -0.059, -0.91 }, { -0.491, 0.629, 2.03 }, { -0.491, -0.019, 0 } },
	AOA_take_off = 0.17,
	AmmoWeight = 147,
	CAS_min = 60,
	...
	DamageParts = { "MIG-29C-OBLOMOK-WING-R", "MIG-29C-OBLOMOK-WING-L" },
	DefaultTask = <1>{
		Name = "CAP",
		OldID = "CAP",
		WorldID = 11
	...
	Pylons = { {
			...
			Launchers = <22>{ {
					...
					CLSID = "<CLEAN>",
					arg_value = 1
				}, <table 7>, <table 8>, <table 9>, <table 10>, <table 11>, <table 12>, <table 13>, <table 14>, <table 15>, <table 16>, <table 17>, <table 18>, <table 19>, <table 20>, <table 21>, <table 5>, {
