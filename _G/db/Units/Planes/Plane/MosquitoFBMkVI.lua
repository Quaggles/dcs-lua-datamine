_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	Damage = { {
		...
		[115] = {
			...
			damage_boundary = 0.111,
			droppable = true,
			failures = { { "ELEC_PORT_LIGHT_DAMAGED", 0.05 } },
			innards = { {
					count = 2,
					id = "XSparWLHI02",
					plenum = 0.18,
		...
		[127] = {
			...
			damage_boundary = 0.111,
			droppable = true,
			failures = { { "ELEC_STBD_LIGHT_DAMAGED", 0.05 } },
			innards = { {
					count = 2,
					id = "XSparWRHI02",
					plenum = 0.18,
	...
	Failures = { {
			...
			hh = 0,
			hidden = false,
			id = "ELEC_PORT_LIGHT_DAMAGED",
			label = "Port landing light damaged",
			mint = 1,
			mm = 0,
			prob = 100
		}, {
			...
			hh = 0,
			hidden = false,
			id = "ELEC_STBD_LIGHT_DAMAGED",
			label = "Starboard landing light damaged",
			mint = 1,
			mm = 0,
			prob = 100
		}, {
			...
			label = "Left tachometer circuit failure",
			mint = 1,
			mm = 0,
			prob = 100
		}, {
			...
			label = "Left tachometer poor connection",
			mint = 1,
			mm = 0,
			prob = 100
		}, {
			...
			label = "Left tachometer indicator adjustment fault",
			mint = 1,
			mm = 0,
			prob = 100
		}, {
			...
			label = "Right tachometer circuit failure",
			mint = 1,
			mm = 0,
			prob = 100
		}, {
			...
			label = "Right tachometer poor connection",
			mint = 1,
			mm = 0,
			prob = 100
		}, {
			...
			label = "Right tachometer indicator adjustment fault",
			mint = 1,
			mm = 0,
			prob = 100
		}, {
	...
	_file = "./CoreMods/WWII Units/MosquitoFBMkVI/MosquitoFBMkVI.lua",
	_origin = "World War II AI Units by Eagle Dynamics",
	ammo_type = { "APIT - AP/De Wilde (Tracer) + 20mm HEI/SAPI/APT", "BaIT - Ball/De Wilde (Tracer) + 20mm HEI/SAPI/APT", "API - AP/De Wilde + 20mm HEI/SAPI", "BaI - Ball/De Wilde + 20mm HEI/SAPI", "CM - Combat Mix", "HE - Anti-Bomber", "AG - Ground Attack", "CS - No Tracers", "NO - Night Time Tracers", "TP - Target Practice" },
