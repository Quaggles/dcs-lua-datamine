_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	Damage = {
		...
		[35] = {
			args = { 225 },
			critical_damage = 7,
			deps_cells = { 29, 86, 37, 11, 17 }
		},
		[36] = {
			args = { 215 },
			critical_damage = 7,
			deps_cells = { 30, 87, 38, 12, 18 }
		},
		[37] = {
			args = { 227 },
			critical_damage = 2
	...
	fires_pos = { { -1, 0, 0 }, { -0.46, 0.77, 1.8 }, { -0.46, 0.77, -1.8 }, { -1.1, 0.72, 4.15 }, { -1.1, 0.72, -4.15 }, { -1.87, 0.255, 8.2 }, { -1.87, 0.255, -8.2 }, { 1.4, -0.37, 2.3 }, { 1.4, -0.37, -2.3 }, { -0.66, -0.22, 2.3 }, { -0.66, -0.22, -2.3 } },
