_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	SFM_Data = {
		aerodynamics = {
			...
			kjx = 2.75,
			kjz = 0.00125,
			table_data = { { 0, 0.025, 0.07, 0.132, 0.032, 0.48, 27, 1.6 }, { 0.2, 0.025, 0.07, 0.132, 0.032, 1.47, 26.5, 1.6 }, { 0.4, 0.025, 0.071, 0.133, 0.032, 2.4, 25.5, 1.5 }, { 0.6, 0.025, 0.073, 0.133, 0.043, 3.5, 25, 1.4 }, { 0.7, 0.025, 0.076, 0.134, 0.045, 3.5, 24, 1.3 }, { 0.8, 0.025, 0.079, 0.137, 0.052, 3.5, 23, 1.2 }, { 0.9, 0.032, 0.083, 0.143, 0.058, 3.5, 22, 1.15 }, { 1, 0.0425, 0.086, 0.18, 0.1, 3.5, 21.25, 1.12 }, { 1.05, 0.056, 0.0875, 0.1975, 0.095, 3.5, 19.375, 1.1 }, { 1.1, 0.055, 0.087, 0.215, 0.09, 3.15, 17.5, 1.05 }, { 1.2, 0.055, 0.086, 0.228, 0.12, 2.45, 15.625, 1 }, { 1.3, 0.054, 0.08, 0.237, 0.17, 1.979, 13.75, 0.912 }, { 1.5, 0.0525, 0.067, 0.25, 0.2, 1.609, 10, 0.74 }, { 1.65, 0.052, 0.06, 0.24, 2.5, 1.469, 10, 0.7 }, { 1.85, 0.051, 0.05, 0.23, 2.98, 1.401, 10, 0.6 }, { 2, 0.05, 0.03, 0.22, 3.2, 1.269, 10, 0.5 } }
		},
		engine = {
			ForsRUD = 0.91,
			MaksRUD = 0.85,
	...
	net_animation = { 83, 190, 191, 192, 200, 201, 208, 209, 38, 23, 130, 131, 132, 133, 182, 184, 186, 188, 35, 36, 37, 334, 335, 611, 612, 613, 419, 900, 901, 950, 951, 952, 953, 954, 955, 956, 957, 958, 959, 961, 962, 963, 964, 965, 966 },
