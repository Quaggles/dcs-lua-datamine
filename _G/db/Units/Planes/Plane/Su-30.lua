		...
		lights = {
			[2] = {
				lights = { {
						...
						exposure = { { 0, 0.98, 1 } },
						movable = true,
						position = { 5.4, -0.234, -0.154 },
						proto = <table 4>,
						typename = "Spot"
					}, {
						exposure = { { 0, 0.98, 1 } },
						movable = true,
						position = { 5.65, -0.234, -0.154 },
						proto = <table 4>,
						range = 4,
						typename = "Omni"
					}, {
