_G["db"]["Units"]["Planes"]["Plane"]["#Index"] = {
	...
	AddPropAircraft = { {
			...
			playerOnly = true,
			values = { {
					dispName = "Historic (based on livery)",
					id = 0
				}, {
					dispName = "On",
					id = 1
				}, {
					dispName = "Off (Historic Variant)",
					id = 2
				}, {
					dispName = "Off (Bulletcover Variant)",
					id = 3
				}, {
					dispName = "Off (Chinpod Variant)",
					id = 4
				} },
			wCtrl = 170
		} },
	...
	DisplayName = "F-14A-135-GR (Early)",
	EmptyWeight = 19090,
	Failures = { {
			enable = false,
			hh = 0,
			...
			hh = 0,
			id = "W_MF_L_J",
			label = "Wings: Left Main Flap Failure (Jammed)",
			mm = 0,
			mmint = 1,
			prob = 100
		}, {
			...
			hh = 0,
			id = "W_MF_R_J",
			label = "Wings: Right Main Flap Failure (Jammed)",
			mm = 0,
			mmint = 1,
			prob = 100
		}, {
			...
			hh = 0,
			id = "W_AF_L_J",
			label = "Wings: Left Aux Flap Failure (Jammed)",
			mm = 0,
			mmint = 1,
			prob = 100
		}, {
			...
			hh = 0,
			id = "W_AF_R_J",
			label = "Wings: Right Aux Flap Failure (Jammed)",
			mm = 0,
			mmint = 1,
			prob = 100
		}, {
	...
	Guns = { {
			_file = "./CoreMods/aircraft/F14/Entry/F-14A.lua",
	...
	HumanFM = { "F-14B by Heatblur Simulations", "F14-FlightModel",
		...
		suspension = { {
				...
				wheel_damage_speed = 97.7436,
				wheel_damage_speedX = 97.7436,
				...
				amortizer_back_damper_force_factor = 27200,
				amortizer_basic_length = 0.65,
				amortizer_direct_damper_force_factor = 64000,
				amortizer_max_length = 0.65,
				amortizer_reduce_length = 0.01,
				amortizer_spring_force_factor = 1200000,
				amortizer_spring_force_factor_rate = 4,
				amortizer_static_force = 6672.33,
				anti_skid_gain = 200,
				...
				crossover_locked_wheel_protection_speed_min = 5.1444,
				...
				noise_k = 0.7,
				self_attitude = false,
				wheel_brake_moment_max = 30000,
				wheel_damage_delta_speedX = 23.1498,
				wheel_damage_force_factor = 450,
				wheel_damage_speed = 97.7436,
				wheel_damage_speedX = 97.7436,
				wheel_glide_friction_factor = 0.2,
				wheel_kz_factor = 0,
	...
	net_animation = { 1609, 1610, 1305, 1611, 1612, 404, 405, 507, 508, 1500, 1501, 434, 433, 28, 29, 23, 1001, 1003, 1004, 1002, 1022, 1021, 450, 406, 21, 182, 184, 1012, 1013, 1011, 1010, 509, 1020, 400, 401, 402, 25, 85, 22, 6000, 6001, 6002, 1614, 1600, 1601, 1603, 626, 627, 600, 605, 606, 607, 608, 700, 3600, 3601, 3602, 3603, 3604, 3605, 3606, 3607, 3610, 3611, 3612, 3613, 2500, 2501, 200, 615, 625 },
