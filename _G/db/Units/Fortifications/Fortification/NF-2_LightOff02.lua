_G["db"]["Units"]["Fortifications"]["Fortification"]["#Index"] = {
	DisplayName = "M92 NF-2 LightOff 02",
	Life = 2,
	Name = "M92 NF-2 LightOff 02",
	Rate = 1,
	SeaObject = false,
	ShapeName = "M92_NF-2_LightOff02",
	ShapeNameDestr = "M92_NF-2_dst",
	...
	shape_table_data = { {
			...
			desrt = "M92_NF-2_dst",
			file = "M92_NF-2_LightOff02",
			life = 2,
			name = "M92_NF-2_LightOff02",
			positioning = "ADD_HEIGTH",
			username = "NF-2_LightOff02"
		}, {
			file = "M92_NF-2_dst",
			name = "M92_NF-2_dst"
		} },
