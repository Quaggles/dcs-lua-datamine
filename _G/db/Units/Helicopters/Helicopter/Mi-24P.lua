_G["db"]["Units"]["Helicopters"]["Helicopter"]["#Index"] = {
	AddPropAircraft = { {
			...
			control = "checkbox",
			defValue = false,
			hint = "Disables bearing/angle hintboxes of the designating\ncrosshair for Petrovich during the mission",
			id = "HideAngleBoxes",
	...
	Pylons = { {
			...
			DisplayName = "4",
			Launchers = { <table 8>, <table 9>, <table 10>, <table 11>, <table 12>, <table 13>, <table 14>, <table 15>, <table 16>, <table 17>, <table 18>, <table 19>, <table 20>, <table 21>, <table 22>, <table 23>, <table 24>, <table 25>, <table 26>, <table 27>, <table 28>, {
	...
	mechanimations = {
		CargoBayGates = { {
				Sequence = { {
						...
						C = { { "Arg", 38, "to", 1, "speed", 0.35 } }
					}, {
						C = { { "Sleep", "for", 1.5 } }
					}, {
						C = { { "Arg", 86, "to", 1, "speed", 0.35 } }
					} },
				...
				Sequence = { {
						...
						C = { { "VelType", 1 }, { "Arg", 38, "to", 0, "speed", 0.34 } }
					}, {
						C = { { "PosType", 6 }, { "Sleep", "for", 2 } }
					}, {
						C = { { "Arg", 86, "to", 0, "speed", 0.35 } }
					} },
				...
				Sequence = { {
						...
						C = { { "VelType", 1 }, { "Arg", 38, "to", 0, "speed", 0.35 } }
					}, {
						C = { { "PosType", 6 }, { "Sleep", "for", 2 } }
					}, {
						C = { { "Arg", 86, "to", 0, "speed", 0.35 } }
