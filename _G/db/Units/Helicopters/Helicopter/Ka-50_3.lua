_G["db"]["Units"]["Helicopters"]["Helicopter"]["#Index"] = {
	AddPropAircraft = { {
			...
			label = "Modification",
			values = { {
					dispName = "Version 2022",
					id = "Ka-50_3",
					value = 1
				}, {
					dispName = "Version 2011",
					id = "Ka-50",
					value = 0
				} },
			wCtrl = 150
	...
	AmmoWeight = 450.8,
	CanopyGeometry = { -0.25881904510252, -0.61237243569579, -0.96592582628907, -0.049950211252315, 0.86602540378444 },
	Categories = {},
	Countermeasures = {
		DISPENSER = "UV-26"
	},
	Damage = { {
		...
		[63] = {
			args = { 53 },
			critical_damage = 10,
			deps_cells = { 64, 65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81 }
		},
		[64] = {
			args = { 117 },
			critical_damage = 5,
	...
	DamageParts = { "Ka-50_3-wing-R", "Ka-50_3-wing-L", "KA-50-NOSE", "Ka-50_3-tail", "KA-50-BLADE" },
	DefaultTask = <1>{
		Name = "CAS",
		OldID = "CAS",
		WorldID = 31
	...
	H_stat_max_L = 5070,
	HumanCockpit = true,
	HumanCockpitPath = "./Mods/aircraft/Ka-50_3/Cockpit/Scripts/",
	HumanCockpitPlugins = { {
	...
	HumanCommPanelPath = "./Mods/aircraft/Ka-50_3/comm.lua",
	HumanFM = { "Ka-50 Black Shark 3 by Eagle Dynamics", "Ka50" },
	HumanRadio = {
		editable = true,
		frequency = 124,
		maxFrequency = 400,
	...
	ViewSettings = {
		...
		Cockpit = { {
				...
				CockpitAnchorPoint = { 3.13, 0.465, 0 },
				CockpitLocalPoint = { 3.13, 0.465, 0 },
				EyePoint = { 0.05, 0.1, 0 },
				ShoulderSize = 0.25,
				limits_6DOF = {
					roll = 90,
	...
	WorldID = 326,
	_file = "./CoreMods/aircraft/Ka-50/Ka-50_3.lua",
	_file_flyable = "./Mods/aircraft/Ka-50_3/entry.lua",
	_origin = "Ka-50 Black Shark",
	_origin_flyable = "Ka-50 Black Shark 3 by Eagle Dynamics",
	apu_rpm_delay_ = 2,
	...
	mechanimations = {
		...
		Crewman0GesturesHMSActions = { {
				Sequence = { {
						...
						C = { { "Arg", 507, "to", 0, "speed", 0.25 }, { "Arg", 506, "to", 0, "speed", 0.125 } }
					} },
				Transition = { "Any", "Dismantle" }
			}, {
				Sequence = { {
						C = { { "Arg", 509, "set", 0.75 } }
					} },
				Transition = { "Any", "Erect" }
			}, {
				Flags = { "Reversible" },
				Sequence = { {
						C = { { "Arg", 507, "to", 0, "speed", 0.25 }, { "Arg", 506, "to", 0, "speed", 0.125 } }
				...
				Flags = { "Reversible" },
				Sequence = { {
						C = { { "Arg", 507, "to", 0.5, "speed", 0.25 }, { "Arg", 506, "to", 0, "speed", 0.125 } }
					} },
		...
		Crewman0GesturesMoveSunglass = { {
				Sequence = { {
						...
						C = { { "Arg", 508, "to", 0, "speed", 0.5 } }
					} },
				Transition = { "Any", "Retract" }
			}, {
				Sequence = { {
						C = { { "Arg", 508, "to", 1, "speed", 0.5 } }
					} },
				Transition = { "Any", "Extend" }
			} },
		Crewman0GesturesNVGActions = { {
				Sequence = { {
						...
						C = { { "Arg", 506, "to", 0, "speed", 0.125 }, { "Arg", 507, "to", 0, "speed", 0.25 } }
					} },
				Transition = { "Any", "Dismantle" }
			}, {
				Sequence = { {
				...
				Flags = { "Reversible" },
				Sequence = { {
						C = { { "Arg", 506, "to", 0.25, "speed", 0.125 }, { "Arg", 507, "to", 0, "speed", 0.25 } }
					} },
				Transition = { "Any", "Extend" }
			} },
		Door0 = { {
				Flags = { "Reversible" },
				Sequence = { {
						C = { { "Arg", 38, "from", 0, "to", 1, "in", 1.356 } }
					} },
				Transition = { "Close", "Open" }
			}, {
				Flags = { "Reversible", "StepsBackwards" },
				Sequence = { {
						C = { { "Arg", 38, "from", 1, "to", 0, "in", 2.927 } }
					} },
				Transition = { "Open", "Close" }
			}, {
				Sequence = { {
						C = { { "Origin", "x", 0.7, "y", 2, "z", 0 }, { "Impulse", 1, "tertiary", 10 }, { "Impulse", 2, "tertiary", 10 }, { "DamagePart", "BLADE_1_IN", "to", 1000 }, { "DamagePart", "BLADE_2_IN", "to", 1000 }, { "DamagePart", "BLADE_3_IN", "to", 1000 }, { "DamagePart", "BLADE_4_IN", "to", 1000 }, { "DamagePart", "BLADE_5_IN", "to", 1000 }, { "DamagePart", "BLADE_6_IN", "to", 1000 }, { "Sleep", "for", 0.5 } }
					}, {
						C = { { "Arg", 25, "to", 1, "in", 0.5 }, { "Sleep", "for", 0 } }
					} },
				Transition = { "Any", "Bailout" }
			} },
		HeadLights = { {
				Sequence = { {
						C = { { "Arg", 209, "to", 0, "speed", 0.14 }, { "Arg", 44, "to", 0, "speed", 0.14 }, { "Arg", 208, "to", 0, "speed", 0.14 }, { "Arg", 43, "to", 0, "speed", 0.14 } }
					} },
				Transition = { "Any", "Retract" }
			}, {
				Sequence = { {
		...
		WindscreenWiper0 = { {
				...
				Sequence = { {
						C = { { "Arg", 13, "to", 0, "at", 1.5, "sign", -1 } }
					} },
				Transition = { "Any", "Retract" }
			}, {
				Sequence = { {
						C = { { "Arg", 13, "to", 1, "at", 5, "sign", 1 } }
					}, {
						C = { { "Arg", 13, "to", 0, "at", 5, "sign", -1 } }
					}, {
						C = { { "ValuePhase", 0 } }
					} },
		...
		WindscreenWiper1 = { {
				...
				Sequence = { {
						C = { { "Arg", 14, "to", 0, "at", 1.5, "sign", -1 } }
					} },
				Transition = { "Any", "Retract" }
			}, {
				Sequence = { {
						C = { { "Arg", 14, "to", 1, "at", 1.5, "sign", 1 } }
					}, {
						C = { { "Arg", 14, "to", 0, "at", 1.5, "sign", -1 } }
					}, {
						C = { { "ValuePhase", 0 } }
	...
	panelRadio = { {
			...
			channels = { {
					...
					default = 0.525,
					modulation = "AM",
					name = "Channel 5, Outer"
				}, {
					default = 1.065,
					modulation = "AM",
					name = "Channel 5, Inner"
				}, {
					default = 0.718,
					modulation = "AM",
					name = "Channel 6, Outer"
				}, {
					default = 0.35,
					modulation = "AM",
					name = "Channel 6, Inner"
				}, {
					default = 0.583,
					modulation = "AM",
					name = "Channel 7, Outer"
				}, {
					default = 0.283,
					modulation = "AM",
					name = "Channel 7, Inner"
				}, {
					default = 0.995,
					modulation = "AM",
					name = "Channel 8, Outer"
				}, {
					default = 1.21,
					modulation = "AM",
					name = "Channel 8, Inner"
				} },
			displayUnits = "kHz",
			name = "ARK-22",
			range = {
