	...
	mechanimations = {
		CargoBayGates = { {
				Sequence = { {
						...
						C = { { "Arg", 38, "to", 1, "speed", 0.5 } }
					}, {
						C = { { "Sleep", "for", 1.5 } }
					}, {
						C = { { "Arg", 86, "to", 1, "speed", 0.2 } }
					} },
				...
				Sequence = { {
						...
						C = { { "VelType", 1 }, { "Arg", 86, "to", 0, "speed", 0.2 } }
					}, {
						C = { { "PosType", 6 }, { "Sleep", "for", 2 } }
					}, {
						C = { { "Arg", 38, "to", 0, "speed", 0.5 } }
					} },
