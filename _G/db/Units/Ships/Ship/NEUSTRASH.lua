_G["db"]["Units"]["Ships"]["Ship"]["#Index"] = {
	...
	DisplayNameShort = "Neustrashimy",
	Gamma_max = 1,
	Height = 29.9,
	Helicopter_Num_ = 1,
	IR_emission_coeff = 0.35,
	Landing_Point = { -48.6, 5.3, 0 },
	Length = 131,
	...
	Sensors = {
		...
		RADAR = { "Tor 9A331", "2S6 Tunguska", "neustrashimy search radar" }
	},
	Singleton = "no",
	Tail_Width = 12.7,
	ThreatRange = 12000,
	WS = { {
			...
			angles = { { 2.6179938779915, -2.6179938779915, -0.2, 1.5707963267949 } },
			board = 1,
			drawArgument1 = 13,
			drawArgument2 = 14,
			newZ = 1,
		...
		radar_type = 104,
		searchRadarFrequencies = { { 1000000000, 2000000000 }, { 2000000000, 3000000000 }, { 3000000000, 4000000000 }, { 8000000000, 12000000000 }, { 9400000000, 9460000000 } },
	...
	attribute = { 3, 12, 14, "Redacted", "Frigates", "RADAR_BAND1_FOR_ARM", "Armed Ship", "HelicopterCarrier", "Naval", "All", "Ships", "Armed ships", "Armed Air Defence", "HeavyArmoredUnits", "Heavy armed ships" },
	chassis = {},
	distFindObstacles = 419,
	draft = 9,
	economy_distance = 8334000,
	economy_velocity = 8.23111,
	life = 2180,
