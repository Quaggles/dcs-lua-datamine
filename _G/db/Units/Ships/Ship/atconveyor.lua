_G["db"]["Units"]["Ships"]["Ship"]["#Index"] = {
	...
	HelicopterSpawnTerminal = { {
			Points = { { { 59.444, 12.28, 0 }, 0 } },
			TerminalIdx = 1
		}, {
			Points = { { { -86.8, 14.18, 0 }, 0 } },
			TerminalIdx = 2
		},
		TerminalNumber = 2
	},
	Helicopter_Num_ = 1,
	Landing_Point = { 59.072, 12.28, 0 },
	Length = 211.316,
	MaxSpeed = 42.588,
	...
	R_min = 665.8,
	Rate = 5500,
	RunWays = { { { 59.072, 12.28, 0 }, 0, 5, 25, 0, 2.5, 2.8, 3, 3, 3.2, 3.5 }, { { 59.072, 12.28, 0 }, 0, 2, 25, 0, 2.5, 2.8, 3, 3, 3.2, 3.5 },
		RunwaysNumber = 2
	},
	Sensors = {
	...
	Tail_Width = 10.07,
	TaxiForTORoutes = { {
			Points = { { { 7.791, 12.28, -5.732 }, 1 }, { { 34.954, 12.28, -1.911 }, 2 }, { { 39, 12.28, 0 }, 1 } },
			RunwayIdx = 1
		}, {
			Points = { { { 8, 12.28, 6.436 }, 1 }, { { 34.954, 12.28, 1.911 }, 2 }, { { 39, 12.28, 0 }, 1 } },
			RunwayIdx = 1
		}, {
			Points = { { { -15.371, 12.28, -5.933 }, 1 }, { { 34.954, 12.28, -1.911 }, 2 }, { { 39, 12.28, 0 }, 1 } },
			RunwayIdx = 1
		}, {
			Points = { { { -15.161, 12.28, 6.838 }, 2 }, { { 34.954, 12.28, 1.911 }, 2 }, { { 39, 12.28, 0 }, 1 } },
			RunwayIdx = 1
		}, {
			Points = { { { -29.479, 12.28, -5.933 }, 2 }, { { 34.954, 12.28, -1.911 }, 2 }, { { 39, 12.28, 0 }, 1 } },
			RunwayIdx = 1
		}, {
			Points = { { { -29.479, 12.28, 6.938 }, 2 }, { { 34.954, 12.28, 1.911 }, 2 }, { { 39, 12.28, 0 }, 1 } },
			RunwayIdx = 1
		},
		RoutesForTONumber = 6
	},
	TaxiRoutes = { { { { 40.5, 12.28, 0 }, -1 }, { { 39, 12.28, 0 }, -1 }, { { 34.954, 12.28, 0 }, -2 }, { { 11.5, 12.28, 0 }, -2 }, { { 5, 12.28, 1 }, -2 }, { { -29.479, 12.28, 6.93 }, -2, 120 } }, { { { 40.5, 12.28, 0 }, -1 }, { { 39, 12.28, 0 }, -1 }, { { 34.954, 12.28, 0 }, -2 }, { { 11.5, 12.28, 0 }, -2 }, { { 5, 12.28, -1 }, -2 }, { { -29.479, 12.28, -6.53 }, -2, 120 } }, { { { 40.5, 12.28, 0 }, -1 }, { { 39, 12.28, 0 }, -1 }, { { 34.954, 12.28, 0 }, -2 }, { { 5, 12.28, 1 }, -2 }, { { -7.791, 12.28, 6.83 }, -2, 120 } }, { { { 40.5, 12.28, 0 }, -1 }, { { 39, 12.28, 0 }, -1 }, { { 34.954, 12.28, 0 }, -2 }, { { 5, 12.28, -1 }, -2 }, { { -7.791, 12.28, -5.93 }, -1, 120 } }, { { { 40.5, 12.28, 0 }, -1 }, { { 39, 12.28, 0 }, -1 }, { { 35, 12.28, 0 }, -2 }, { { 31, 12.28, 3 }, -2 }, { { 18, 12.28, 5.93 }, -1, 120 } }, { { { 40.5, 12.28, 0 }, -1 }, { { 39, 12.28, 0 }, -1 }, { { 35, 12.28, 0 }, -2 }, { { 31, 12.28, -3 }, -2 }, { { 18, 12.28, -4.93 }, -1, 120 } },
		RoutesNumber = 6
	},
	ThreatRange = 74000,
	WS = {
