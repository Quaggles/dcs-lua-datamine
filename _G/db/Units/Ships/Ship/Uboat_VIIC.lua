_G["db"]["Units"]["Ships"]["Ship"]["#Index"] = {
	...
	attribute = { 3, 12, 16, "Redacted", "Submarines", "RADAR_BAND1_FOR_ARM", "NO_SAM", "Armed Ship", "All", "Ships", "Armed ships", "Armed Air Defence", "HeavyArmoredUnits", "Heavy armed ships" },
	baseSubmersion = 1.5,
	chassis = {},
