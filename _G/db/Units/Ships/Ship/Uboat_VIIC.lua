_G["db"]["Units"]["Ships"]["Ship"]["#Index"] = {
	...
	WS = { {
			...
			LN = { {
					BR = { {
							connector_name = "Point_MachineGun01_1",
							recoilArgument = 121,
							recoilTime = 0.12
						}, {
							connector_name = "Point_MachineGun01_2",
							recoilArgument = 120,
							recoilTime = 0.12
						} },
					PL = { {
			...
			LN = { {
					BR = { {
							connector_name = "Point_MachineGun02_1",
							recoilArgument = 123,
							recoilTime = 0.12
						}, {
							connector_name = "Point_MachineGun02_2",
							recoilArgument = 122,
							recoilTime = 0.12
						} },
					PL = { {
			...
			LN = { {
					BR = { {
							connector_name = "POINT_TORPEDO_01",
							recoilArgument = 179,
							recoilT0 = -5,
							recoilT1 = -3,
							recoilT2 = 3,
							...
							connector_name = "POINT_TORPEDO_02",
							recoilArgument = 177,
							recoilT0 = -5,
							recoilT1 = -3,
							recoilT2 = 3,
							...
							connector_name = "POINT_TORPEDO_03",
							recoilArgument = 180,
							recoilT0 = -5,
							recoilT1 = -3,
							recoilT2 = 3,
							...
							connector_name = "POINT_TORPEDO_04",
							recoilArgument = 178,
							recoilT0 = -5,
							recoilT1 = -3,
							recoilT2 = 3,
	...
	attribute = { 3, 12, 16, "Redacted", "Submarines", "RADAR_BAND1_FOR_ARM", "NO_SAM", "Armed Ship", "Naval", "All", "Ships", "Armed ships", "Armed Air Defence", "HeavyArmoredUnits", "Heavy armed ships" },
	baseSubmersion = 1.5,
	chassis = {},
	...
	max_velocity = 9.11,
	minPeriscopeDepth = 7,
	periscopeHeight = 11.8,
	race_distance = 778000,
	race_velocity = 9.11,
	shape_table_data = { {
	...
	snd = {},
	speedup = 0.269786,
	sternEffectDX = { { 0, 0, 68.7, 11.5 }, { 2.7, 0, 68.7, 11.5 }, { 3.3, 25.5, 13, 6 }, { 7.35, 25.5, 13, 6 } },
	swapped_names = true,
	tags = { "Submarine" },
	type = "Uboat_VIIC",
	visual = {
