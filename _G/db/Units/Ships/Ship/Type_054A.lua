_G["db"]["Units"]["Ships"]["Ship"]["#Index"] = {
	...
	WS = { {
			...
			angles_mech = { { -2.6179938779915, -0.5235987755983, -0.43633231299858, 1.5184364492351 } },
			area = "BORT_L",
			...
			angles_mech = { { 0.5235987755983, 2.6179938779915, -0.43633231299858, 1.5184364492351 } },
			area = "BORT_R",
