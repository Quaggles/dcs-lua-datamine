_G["db"]["Units"]["Ships"]["Ship"]["#Index"] = {
	...
	DM = { {
			...
			area_life = 60,
			area_name = "DMG-HULL-AW-FWD-STBD"
		}, {
			area_arg = 76,
			area_fire = {
				pos = { 42.2, -2.4, 1.73 },
			...
			area_life = 60,
			area_name = "DMG-HULL-AW-FWD-PORT"
		}, {
			area_arg = 77,
			area_fire = {
				pos = { 38.3, 0, -2.9 },
			...
			area_life = 60,
			area_name = "DMG-HULL-AW-AND-TURRET-A"
		}, {
			area_arg = 79,
			area_fire = {
				pos = { 10.2, 0, -2.2 },
			...
			area_life = 60,
			area_name = "DMG-HULL-BW-FWD-MIDSHIPS"
		}, {
			area_arg = 80,
			area_fire = {
				pos = { 10.8, 0, 5.6 },
			...
			area_life = 60,
			area_name = "DMG-HULL-AW-FWD-MIDSHIPS-STBD"
		}, {
			area_arg = 82,
			area_fire = {
				pos = { 5, -6.45, 1.3 },
			...
			area_life = 60,
			area_name = "DMG-HULL-AW-FWD-MIDSHIPS-PORT"
		}, {
			Area_arg = 83,
			area_fire = {
				pos = { -7.9, 0, 5 },
			...
			area_life = 60,
			area_name = "DMG-SS-REAR-MIDSHIPS-FUNNEL"
		}, {
			area_arg = 84,
			area_fire = {
				pos = { -14.3, 6.45, 1.3 },
			...
			area_life = 60,
			area_name = "DMG-HULL-AW-AFT-MIDSHIPS-STBD"
		}, {
			area_arg = 85,
			area_fire = {
				pos = { -14.3, -6.45, 1.3 },
			...
			area_life = 60,
			area_name = "DMG-HULL-AW-AFT-MIDSHIPS-PORT"
		}, {
			area_arg = 86,
			area_fire = {
				pos = { -19.7, 0, 6.15 },
			...
			area_life = 60,
			area_name = "DMG-SS-AFT-SEACAT-HANGAR"
		}, {
			area_arg = 87,
			area_fire = {
				pos = { -21.9, 0, 1.3 },
			...
			area_life = 60,
			area_name = "DMG-HULL-BW-AFT-ENGINE-PLANT"
		}, {
			area_arg = 88,
			area_fire = {
				pos = { -30.5, 0, 3.6 },
			...
			area_life = 60,
			area_name = "DMG-AFT-HULL-AND-LIMBO"
		}, {
			area_arg = 90,
			area_fire = {
				pos = { -49.9, 0, 1.3 },
	...
	WS = { {
			...
			angles = { { -1.5707963267949, -0.69813170079773, 0, 1.553343034275 }, { -0.69813170079773, 0.5235987755983, 1.3089969389957, 1.553343034275 } },
	...
	X_nose = 56.851,
	X_tail = -56.857,
	_file = "./CoreMods/tech/SouthAtlanticAssets/Entries/Navy/achilles.lua",
