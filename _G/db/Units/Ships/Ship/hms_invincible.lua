_G["db"]["Units"]["Ships"]["Ship"]["#Index"] = {
	...
	DM = { {
			...
			area_life = 150,
			area_name = "COL-HULL-BELOW-WL-FWD"
		}, {
			area_arg = 79,
			area_fire = {
				pos = { -31.3, 0, -7 },
			...
			area_life = 150,
			area_name = "COL-HULL-BELOW-WL-AFT"
		}, {
			area_arg = 80,
			area_fire = {
				pos = { -101, 0, 6.2 },
			...
			area_life = 30,
			area_name = "COL-LAUNCHER"
		} },
	DeckLevel = 14.709,
	DetectionRange = 416000,
	...
	Singleton = "yes",
	TACAN = true,
	TACAN_position = { 7.006, 43.155, -14.1 },
	Tail_Width = 14.8,
	TaxiForTORoutes = { {
			Points = { { { -98.8, 14.709, 10.5 }, 1 }, { { -98.8, 14.709, 2 }, 1 }, { { -98.8, 14.709, -5.8 }, 1 }, { { -96.3, 14.709, -9.5 }, 1 }, { { -88.5, 14.709, -9.536 }, 0.5 } },
			RunwayIdx = 1
		}, {
			Points = { { { -83.9, 14.709, 9.9 }, 1 }, { { -89.5, 14.709, 2 }, 1 }, { { -98.8, 14.709, 2 }, 1 }, { { -98.8, 14.709, -5.8 }, 1 }, { { -96.3, 14.709, -9.5 }, 1 }, { { -88.5, 14.709, -9.536 }, 0.5 } },
			RunwayIdx = 1
		}, {
			Points = { { { -71.7, 14.709, 10 }, 1 }, { { -77.4, 14.709, 2 }, 1 }, { { -89.5, 14.709, 2 }, 1 }, { { -98.8, 14.709, 2 }, 1 }, { { -98.8, 14.709, -5.8 }, 1 }, { { -96.3, 14.709, -9.5 }, 1 }, { { -88.5, 14.709, -9.536 }, 0.5 } },
			RunwayIdx = 1
		}, {
			Points = { { { -60, 14.709, 9.6 }, 1 }, { { -65.3, 14.709, 2 }, 1 }, { { -77.4, 14.709, 2 }, 1 }, { { -89.5, 14.709, 2 }, 1 }, { { -98.8, 14.709, 2 }, 1 }, { { -98.8, 14.709, -5.8 }, 1 }, { { -96.3, 14.709, -9.5 }, 1 }, { { -88.5, 14.709, -9.536 }, 0.5 } },
			RunwayIdx = 1
		},
		RoutesForTONumber = 4
	},
	TaxiRoutes = { { { { -40, 14.709, -9 }, 2 }, { { -80, 14.709, -5.5 }, 2 }, { { -102, 14.709, 2.5 }, -2 } }, { { { -40, 14.709, -9 }, 2 }, { { -75, 14.709, -4 }, 2 }, { { -96, 14.709, 11.5 }, -2 } }, { { { -40, 14.709, -9 }, 2 }, { { -85, 14.709, -5.5 }, 2 }, { { -85, 14.709, 12 }, -2 } }, { { { -40, 14.709, -9 }, 2 }, { { -72, 14.709, -5 }, 2 }, { { -72, 14.709, 12 }, -1 } }, { { { -40, 14.709, -9 }, 2 }, { { -60, 14.709, -5.5 }, 2 }, { { -60, 14.709, 12 }, -1 } }, { { { 0, 14.709, -5 }, 2 }, { { 10, 14.709, 2 }, 2 }, { { 58, 14.709, 3 }, 1 } },
		RoutesNumber = 6
	},
	ThreatRange = 80000,
	WS = { {
			...
			LN = { {
					BR = { {
							connector_name = "CON-SEA-DART-ATTACH-PORT"
						}, {
							connector_name = "CON-SEA-DART-ATTACH-STBD"
						} },
					PL = { {
							ammo_capacity = 22,
							type_ammunition = {}
	...
	X_nose = 97.466,
	X_tail = -99.319,
	_file = "./CoreMods/tech/SouthAtlanticAssets/Entries/Navy/HMS_Invincible.lua",
	...
	exhaust = { {
			pos = { 12.985, 32.656, 8.003 },
			size = 0.18
		}, {
			pos = { -21.742, 30.148, 8.003 },
			size = 0.18
		}, {
			pos = { 9.985, 32.656, 8.003 },
			size = 0.18
		}, {
			pos = { -24.742, 30.148, 8.003 },
			size = 0.18
		} },
	life = 7200,
