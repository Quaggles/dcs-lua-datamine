_G["db"]["Units"]["Cars"]["Car"]["#Index"] = {
	...
	shape_table_data = { {
			...
			desrt = "soldier_wwii_de_01_d",
			file = "soldier_wwii_de_01",
			life = 6,
			name = "soldier_wwii_de_01",
			positioning = "BYNORMAL",
			username = "soldier_mauser98"
		}, {
			file = "soldier_wwii_de_01_d",
			name = "soldier_wwii_de_01_d"
		} },
	snd = {},
	swapped_names = true,
	tags = { "Infantry" },
