_G["db"]["Units"]["Cars"]["Car"]["#Index"] = {
	...
	visual = {
		IR = {
			...
			sources = { { { 3.1, 1.8, 0 }, 1.3, 0.5, 0.2 }, { { 2.58, 0.65, 1.07 }, 0.7, 0.4, 0 }, { { 2.58, 0.65, -1.07 }, 0.7, 0.4, 0 }, { { -0.71, 0.65, 1.07 }, 0.7, 0.4, 0 }, { { -0.71, 0.65, -1.07 }, 0.7, 0.4, 0 }, { { -1.89, 0.65, 1.07 }, 0.7, 0.4, 0 }, { { -1.89, 0.65, -1.07 }, 0.7, 0.4, 0 } }
		},
