_G["db"]["Units"]["Cars"]["Car"]["#Index"] = {
	...
	WS = { {
			LN = { {
					...
					PL = { {
							...
							reload_time = 2160,
							shot_delay = 0.1,
							type_ammunition = "weapons.nurs.SMERCH_9M55K"
						} },
	...
	visual = {
		IR = {
			coeffs = { { 0.031, 0.0022, 3 }, { 0.0069, 0.0036, 4.8 }, { 0.023, 0.002 }, { 0.01, 0.0017 }, { 0.25, 0.00022727272727273 } }
		},
