_G["db"]["Units"]["Cars"]["Car"]["#Index"] = {
	...
	WS = { {
		...
		maxTargetDetectionRange = 463000,
		radar_rotation_type = 0,
		radar_type = 105,
		requiredUnits = { { "FPS-117 ECS", 50, 2 } },
	...
	sensor = {
		...
		max_range_finding_target = 463000,
		min_range_finding_target = 0
	},
	shape_table_data = { {
			classname = "lLandVehicle",
			desrt = "ewr_fps117_p_1",
			file = "ewr_fps117",
			life = 6,
			name = "ewr_fps117",
			positioning = "ONLYHEIGTH",
	...
	visual = {
		IR = {
			coeffs = { { 0.035, 0.0012 }, { 0, 0 }, { 0.31, 0.0044, 1.425 }, { 0.01, 0.0017 }, { 0.2, 0.00019047619047619 } }
		},
