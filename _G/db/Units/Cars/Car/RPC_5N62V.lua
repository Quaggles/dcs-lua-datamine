_G["db"]["Units"]["Cars"]["Car"]["#Index"] = {
	...
	WS = { {
			LN = { {
					...
					depends_on_unit = { { { "self", 2 } }, { { "RLS_19J6" } }, { { "p-19 s-125 sr" } }, { { "P14_SR" } } },
					distanceMax = 400000,
					distanceMin = 17000,
	...
	sensor = {
		...
		min_range_finding_target = 17000
	},
	shape_table_data = { {
	...
	visual = {
		IR = {
			coeffs = { { 0.031, 0.0022, 3 }, { 0, 0 }, { 0.49, 0.005, 1.7 }, { 0.01, 0.0017 }, { 0.2, 0.00026666666666667 } }
		},
		fire_pos = { 0, 0.6, 0 },
		fire_size = 0.5,
		fire_time = 500,
