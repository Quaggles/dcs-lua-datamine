_G["db"]["Units"]["Cars"]["Car"]["#Index"] = {
	...
	Countries = { "USSR", "Russia", "Algeria", "Romania", "GDR", "Bulgaria", "Azerbaijan", "Armenia", "Belarus", "Georgia", "Kazakhstan", "Kyrgyzstan", "Latvia", "Lithuania", "Estonia", "Tajikistan", "Turkmenistan", "Uzbekistan", "Ukraine", "Moldova", "Finland", "Poland", "Czechoslovakia", "Czech Republic", "Slovakia", "Serbia", "Hungary", "Afghanistan" },
	CustomAimPoint = { 0, 1.38, 0 },
	DetectionRange = 0,
	DisplayName = "APC BTR-60",
	DisplayNameShort = "BTR60",
