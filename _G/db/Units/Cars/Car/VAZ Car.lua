_G["db"]["Units"]["Cars"]["Car"]["#Index"] = {
	...
	visual = {
		IR = {
			coeffs = { { 0.031, 0.0022, 3 }, { 0.0069, 0.0036, 4.8 }, { 0, 0 }, { 0.01, 0.0017 }, { 0.22, 0.000275 } },
			sources = { { { 1.5, 0.7, 0.3 }, 1, 0.5, 0 }, { { 1.5, 0.7, -0.3 }, 1, 0.5, 0 }, { { 1.24, 0.3, 0.81 }, 0.35, 0.4, 0 }, { { 1.24, 0.3, -0.81 }, 0.35, 0.4, 0 }, { { -1.29, 0.3, 0.81 }, 0.35, 0.4, 0 }, { { -1.29, 0.3, -0.81 }, 0.35, 0.4, 0 } }
		},
