_G["db"]["Units"]["Cars"]["Car"]["#Index"] = {
	...
	WS = { {
			LN = { {
					...
					distanceMax = 43000,
					distanceMin = 7000,
					inclination_correction_bias = 0.17453292519943,
					inclination_correction_upper_limit = 1.6929693744345,
			...
			angles = { { 3.1415926535898, -3.1415926535898, 0, 1.3089969389957 } },
			drawArgument1 = 0,
			drawArgument2 = 1,
			omegaY = 0.16580627893946,
	...
	visual = {
		IR = {
			coeffs = { { 0.031, 0.0022, 3 }, { 0, 0 }, { 0.065, 0.007 }, { 0, 0 }, { 0.15, 0.00027272727272727 } }
		},
