_G["db"]["Units"]["Cars"]["Car"]["#Index"] = {
	...
	visual = {
		IR = {
			coeffs = { { 0.031, 0.0022, 3 }, { 0.0069, 0.0036, 4.8 }, { 0, 0 }, { 0.01, 0.0017 }, { 0.23, 0.00025555555555556 } },
			sources = { { { 2.8, 1.6, 0 }, 1.3, 0.5, 0.2 }, { { 2.34, 0.53, 1.2 }, 0.6, 0.4, 0 }, { { 2.34, 0.53, -1.2 }, 0.6, 0.4, 0 }, { { -1.48, 0.53, 1.2 }, 0.6, 0.4, 0 }, { { -1.48, 0.53, -1.2 }, 0.6, 0.4, 0 } }
		},
