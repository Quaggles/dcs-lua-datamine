_G["db"]["Countries"]["#Index"] = {
	Awards = { <1>{
			countryID = 18,
			name = "Medal for Bravery",
			nativeName = "Medal for Bravery",
			picture = "Abkhazia/awards/ABH-01-Bravery.png",
			threshold = 400
		}, <2>{
			countryID = 18,
			name = "Orden Leon",
			nativeName = 'Orden "Leon"',
			picture = "Abkhazia/awards/ABH-02-Leon.png",
			threshold = 1800
		}, <3>{
			countryID = 18,
			name = "Orden Glory III",
			nativeName = 'Orden "Akhdz Apsha"',
			picture = "Abkhazia/awards/ABH-03-Glory-III.png",
			threshold = 2600
		}, <4>{
			countryID = 18,
			name = "Hero of Abkhazia",
			nativeName = "Hero of Abkhazia",
			picture = "Abkhazia/awards/ABH-04-Hero.png",
			threshold = 3000
		} },
	InternationalName = "Abkhazia",
	Name = "Abkhazia",
	OldID = "Abkhazia",
	Ranks = { <5>{
	...
	ShortName = "ABH",
	Troops = { <11>{
			name = "Abkhazia Military Forces",
			nativeName = "Abkhazia Military Forces",
			picture = "Abkhazia/troops/MilitaryForces.png"
		} },
	Units = {
		ADEquipments = {
			ADEquipment = { {
	...
	WorldID = 18,
	award_by_name = {
		["Hero of Abkhazia"] = <table 4>,
		["Medal for Bravery"] = <table 1>,
		["Orden Glory III"] = <table 3>,
		["Orden Leon"] = <table 2>
	},
	flag = "FUI/Common/Flags/Abkhazia.png",
	flag_small = "MissionEditor/data/images/flags/Abkhazia.png",
	rank_by_name = {
		Captain = <table 7>,
		Colonel = <table 10>,
	...
	troop_by_name = {
		["Abkhazia Military Forces"] = <table 11>
	}
}