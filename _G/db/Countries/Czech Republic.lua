_G["db"]["Countries"]["#Index"] = {
	...
	Name = "Czech Republic",
	OldID = "Czech Republic",
	Ranks = { <1>{
			name = "Second lieutenant",
			nativeName = "Second lieutenant",
			pictureRect = { 0, 0, 64, 32 },
			stripes = "Czech Republic/stripes.png",
			threshold = 0
		}, <2>{
	...
	Troops = { <7>{
			...
			nativeName = "Czech Air Force",
			picture = "Czech Republic/troops/CzechAirForce.png"
		}, <8>{
			name = "22nd Helicopter Base",
			nativeName = "22nd Helicopter Base",
			picture = "Czech Republic/troops/znak22zl.png"
		}, <9>{
			name = "213th Training Squadron",
			nativeName = "213th Training Squadron",
			picture = "Czech Republic/troops/213n.png"
		} },
	Units = {
		ADEquipments = {
			ADEquipment = { {
	...
	WorldID = 26,
	award_by_name = {},
	flag = "FUI/Common/Flags/Czech Republic.png",
	flag_small = "MissionEditor/data/images/flags/Czech Republic.png",
	rank_by_name = {
		Captain = <table 3>,
		Colonel = <table 6>,
	...
	troop_by_name = {
		["213th Training Squadron"] = <table 9>,
		["22nd Helicopter Base"] = <table 8>,
		["Czech Air Force"] = <table 7>
	}
}