_G["db"]["Countries"]["#Index"] = {
	Awards = { <1>{
			countryID = 16,
			name = 'Medali "Sabrdzolo Damsakhurebisatvis"',
			nativeName = 'Medali "Sabrdzolo Damsakhurebisatvis"',
			picture = "Georgia/awards/GR-01-Medal_for_the_Service_in_Battle.png",
			threshold = 200
		}, <2>{
			countryID = 16,
			name = 'Medali "Mkhedruli Mamatsobisatvis"',
			nativeName = 'Medali "Mkhedruli Mamatsobisatvis"',
			picture = "Georgia/awards/GR-02-Medal_for_Military_Courage.png",
			threshold = 600
		}, <3>{
			countryID = 16,
			name = "Vakhtang Gorgasalis Ordeni III",
			nativeName = "Vakhtang Gorgasalis Ordeni III",
			picture = "Georgia/awards/GR-03-Order_of_Vakhtang_Gorgasali_III.png",
			threshold = 1000
		}, <4>{
			countryID = 16,
			name = "Vakhtang Gorgasalis Ordeni II",
			nativeName = "Vakhtang Gorgasalis Ordeni II",
			picture = "Georgia/awards/GR-04-Order_of_Vakhtang_Gorgasali_II.png",
			threshold = 1400
		}, <5>{
			countryID = 16,
			name = "Vakhtang Gorgasalis Ordeni I",
			nativeName = "Vakhtang Gorgasalis Ordeni I",
			picture = "Georgia/awards/GR-05-Order_of_Vakhtang_Gorgasali_I.png",
			threshold = 1800
		}, <6>{
			countryID = 16,
			name = "Girsebis Ordeni",
			nativeName = "Girsebis Ordeni",
			picture = "Georgia/awards/GR-06-Order_of_Honour.png",
			threshold = 2200
		}, <7>{
			countryID = 16,
			name = "Girsebis Medali",
			nativeName = "Girsebis Medali",
			picture = "Georgia/awards/GR-07-Medal_of_Valour.png",
			threshold = 2600
		}, <8>{
			countryID = 16,
			name = "Okros Satsmisis Ordeni",
			nativeName = "Okros Satsmisis Ordeni",
			picture = "Georgia/awards/GR-08-Order_of_the_Gold_Fleece.png",
			threshold = 3000
		} },
	...
	Troops = { <15>{
			name = "TAM",
			nativeName = "TAM",
			picture = "Georgia/troops/TAM.png"
		} },
	Units = {
		ADEquipments = {
			ADEquipment = { {
	...
	WorldID = 16,
	award_by_name = {
		["Girsebis Medali"] = <table 7>,
		["Girsebis Ordeni"] = <table 6>,
		['Medali "Mkhedruli Mamatsobisatvis"'] = <table 2>,
		['Medali "Sabrdzolo Damsakhurebisatvis"'] = <table 1>,
		["Okros Satsmisis Ordeni"] = <table 8>,
		["Vakhtang Gorgasalis Ordeni I"] = <table 5>,
		["Vakhtang Gorgasalis Ordeni II"] = <table 4>,
		["Vakhtang Gorgasalis Ordeni III"] = <table 3>
	},
	flag = "FUI/Common/Flags/Georgia.png",
	flag_small = "MissionEditor/data/images/flags/Georgia.png",
	rank_by_name = {
		Captain = <table 11>,
		Colonel = <table 14>,
