_G["db"]["Countries"]["#Index"] = {
	...
	ShortName = "AUT",
	Troops = { <7>{
			name = "Austrian Federal Army",
			nativeName = "Austrian Federal Army",
			picture = "Austria/troops/Bundesheer.png"
		} },
	Units = {
		ADEquipments = {
			ADEquipment = {}
	...
	WorldID = 23,
	award_by_name = {},
	flag = "FUI/Common/Flags/Austria.png",
	flag_small = "MissionEditor/data/images/flags/Austria.png",
	rank_by_name = {
		Captain = <table 3>,
		Colonel = <table 6>,
