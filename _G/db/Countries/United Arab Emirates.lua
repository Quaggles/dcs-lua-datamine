_G["db"]["Countries"]["#Index"] = {
	...
	OldID = "United Arab Emirates",
	Ranks = { <1>{
			name = "Second lieutenant",
			nativeName = "Second lieutenant",
			pictureRect = { 0, 0, 64, 32 },
			stripes = "United Arab Emirates/stripes.png",
			threshold = 0
		}, <2>{
	...
	WorldID = 74,
	award_by_name = {},
	flag = "FUI/Common/Flags/United Arab Emirates.png",
	flag_small = "MissionEditor/data/images/flags/United Arab Emirates.png",
	rank_by_name = {
		Captain = <table 3>,
		Colonel = <table 6>,
