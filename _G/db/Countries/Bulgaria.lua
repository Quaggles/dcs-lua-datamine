_G["db"]["Countries"]["#Index"] = {
	...
	Troops = { <7>{
			...
			nativeName = "Bulgarian Air Force",
			picture = "Bulgaria/troops/VVS.png"
		} },
	Units = {
		ADEquipments = {
			ADEquipment = {}
	...
	WorldID = 25,
	award_by_name = {},
	flag = "FUI/Common/Flags/Bulgaria.png",
	flag_small = "MissionEditor/data/images/flags/Bulgaria.png",
	rank_by_name = {
		Captain = <table 3>,
		Colonel = <table 6>,
