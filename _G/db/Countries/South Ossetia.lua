_G["db"]["Countries"]["#Index"] = {
	Awards = { <1>{
			countryID = 19,
			name = "Defender of the Fatherland",
			nativeName = "Defender of the Fatherland",
			picture = "South Ossetia/awards/SOS-01-Defenders_of_the_Fatherland.png",
			threshold = 1800
		}, <2>{
			countryID = 19,
			name = "Uatsamonga",
			nativeName = "Hero of Osetia",
			picture = "South Ossetia/awards/SOS-02-Uatsamonga.png",
			threshold = 3000
		} },
	InternationalName = "South Ossetia",
	Name = "South Ossetia",
	OldID = "South Ossetia",
	Ranks = { <3>{
			...
			stripes = "South Ossetia/stripes.png",
			threshold = 0
		}, <4>{
	...
	ShortName = "RSO",
	Troops = { <9>{
			name = "South Ossetia Military Forces",
			nativeName = "South Ossetia Military Forces",
			picture = "South Ossetia/troops/MilitaryForces.png"
		} },
	Units = {
		ADEquipments = {
			ADEquipment = { {
	...
	WorldID = 19,
	award_by_name = {
		["Defender of the Fatherland"] = <table 1>,
		Uatsamonga = <table 2>
	},
	flag = "FUI/Common/Flags/South Ossetia.png",
	flag_small = "MissionEditor/data/images/flags/South Ossetia.png",
	rank_by_name = {
		Captain = <table 5>,
		Colonel = <table 8>,
	...
	troop_by_name = {
		["South Ossetia Military Forces"] = <table 9>
	}
}