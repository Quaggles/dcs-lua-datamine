_G["db"]["Countries"]["#Index"] = {
	Awards = { <1>{
			countryID = 4,
			name = "British Empire Medal",
			nativeName = "British Empire Medal",
			picture = "UK/awards/UK-01-British_Empire_Medal.png",
			threshold = 200
		}, <2>{
			countryID = 4,
			name = "Air Force Medal",
			nativeName = "Air Force Medal",
			picture = "UK/awards/UK-02-Air_Force_Medal.png",
			threshold = 600
		}, <3>{
			countryID = 4,
			name = "Distinguished Flying Medal",
			nativeName = "Distinguished Flying Medal",
			picture = "UK/awards/UK-03-Distinguished_Flying_Medal.png",
			threshold = 1000
		}, <4>{
			countryID = 4,
			name = "Military Medal",
			nativeName = "Military Medal",
			picture = "UK/awards/UK-04-Military_Medal.png",
			threshold = 1400
		}, <5>{
			countryID = 4,
			name = "Distinguished Conduct Medal",
			nativeName = "Distinguished Conduct Medal",
			picture = "UK/awards/UK-05-Distiguished_Conduct_Medal.png",
			threshold = 1800
		}, <6>{
			countryID = 4,
			name = "Air Force Cross",
			nativeName = "Air Force Cross",
			picture = "UK/awards/UK-06-Air_Force_Cross.png",
			threshold = 2200
		}, <7>{
			countryID = 4,
			name = "Distinguished Flying Cross",
			nativeName = "Distinguished Flying Cross",
			picture = "UK/awards/UK-07-Distinguished_Flying_Cross.png",
			threshold = 2600
		}, <8>{
			countryID = 4,
			name = "Military Cross",
			nativeName = "Military Cross",
			picture = "UK/awards/UK-08-Military_Cross.png",
			threshold = 3000
		} },
	InternationalName = "UK",
	Name = "UK",
	OldID = "UK",
	Ranks = { <9>{
	...
	ShortName = "UK",
	Troops = { <15>{
			name = "11 SQN ROYAL AIR FORCE",
			nativeName = "11 SQN ROYAL AIR FORCE",
			picture = "UK/troops/11sq.png"
		}, <16>{
			name = "13 SQN ROYAL AIR FORCE",
			nativeName = "13 SQN ROYAL AIR FORCE",
			picture = "UK/troops/13sq.png"
		}, <17>{
			name = "111 SQN ROYAL AIR FORCE",
			nativeName = "111 SQN ROYAL AIR FORCE",
			picture = "UK/troops/111sq.png"
		}, <18>{
			name = "DEFENSE HELICOPTER FLYING SCHOOL",
			nativeName = "DEFENSE HELICOPTER FLYING SCHOOL",
			picture = "UK/troops/DEFENSE_HELICOPTER_FLYING_SCHOOL.png"
		}, <19>{
			name = "RAF 7th HS",
			nativeName = "RAF 7th SH",
			picture = "UK/troops/RAF_7th_Squadron_helicopter.png"
		} },
	Units = {
		ADEquipments = {
			ADEquipment = { {
	...
	award_by_name = {
		...
		["Air Force Medal"] = <table 2>,
		["British Empire Medal"] = <table 1>,
		["Distinguished Conduct Medal"] = <table 5>,
		["Distinguished Flying Cross"] = <table 7>,
		["Distinguished Flying Medal"] = <table 3>,
		["Military Cross"] = <table 8>,
		["Military Medal"] = <table 4>
	},
	flag = "FUI/Common/Flags/UK.png",
	flag_small = "MissionEditor/data/images/flags/UK.png",
	rank_by_name = {
		Captain = <table 11>,
		Colonel = <table 14>,
	...
	troop_by_name = {
		["11 SQN ROYAL AIR FORCE"] = <table 15>,
		["111 SQN ROYAL AIR FORCE"] = <table 17>,
		["13 SQN ROYAL AIR FORCE"] = <table 16>,
		["DEFENSE HELICOPTER FLYING SCHOOL"] = <table 18>,
		["RAF 7th HS"] = <table 19>
	}
}