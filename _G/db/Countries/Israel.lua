_G["db"]["Countries"]["#Index"] = {
	...
	ShortName = "ISR",
	Troops = { <10>{
			name = "F-4 THE ONE SQUADRON",
			nativeName = "F-4 THE ONE SQUADRON",
			picture = "Israel/troops/F4-The_One_Squadron.png"
		}, <11>{
			name = "F15 KNIGHTS OF THE TWIN TAIL",
			nativeName = "F15 KNIGHTS OF THE TWIN TAIL",
			picture = "Israel/troops/F15-Knights_of_the_Twin_Tail.png"
		}, <12>{
			name = "F15 THE 2nd F-15 SQUADRON",
			nativeName = "F15 THE 2nd F-15 SQUADRON",
			picture = "Israel/troops/F15-The_2nd_F-15_Squadron.png"
		}, <13>{
			name = "F16 THE FIRST JET SQUADRON",
			nativeName = "F16 THE FIRST JET SQUADRON",
			picture = "Israel/troops/F16-The_First_Jet_Squadron.png"
		}, <14>{
			name = "F16 THE VALLEY SQUADRON",
			nativeName = "F16 THE VALLEY SQUADRON",
			picture = "Israel/troops/F16-The_Valley_Squadron.png"
		}, <15>{
			name = "IDF 1st HS GUNSHIPS AH-1",
			nativeName = "IDF 1st HS GUNSHIPS AH-1",
			picture = "Israel/troops/IDF_1st_HELICOPTER_GUNSHIPS_AH-1_SQUADRON.png"
		}, <16>{
			name = "CH-53A HS IAF AIR FORCE",
			nativeName = "CH-53A HS IAF AIR FORCE",
			picture = "Israel/troops/CH-53A_HELICOPTER_SQUADRON_AIR_FORCE_IAF.png"
		} },
	Units = {
		ADEquipments = {
			ADEquipment = { {
	...
	troop_by_name = {
		["CH-53A HS IAF AIR FORCE"] = <table 16>,
		["F-4 THE ONE SQUADRON"] = <table 10>,
		["F15 KNIGHTS OF THE TWIN TAIL"] = <table 11>,
		["F15 THE 2nd F-15 SQUADRON"] = <table 12>,
		["F16 THE FIRST JET SQUADRON"] = <table 13>,
		["F16 THE VALLEY SQUADRON"] = <table 14>,
		["IDF 1st HS GUNSHIPS AH-1"] = <table 15>
	}
}