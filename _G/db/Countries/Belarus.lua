_G["db"]["Countries"]["#Index"] = {
	...
	ShortName = "BLR",
	Troops = { <7>{
			name = "206th Assault Air Base",
			nativeName = "206th Assault Air Base",
			picture = "Belarus/troops/206.png"
		}, <8>{
			name = "181th Helicopter Air Base",
			nativeName = "181th Helicopter Air Base",
			picture = "Belarus/troops/181.png"
		}, <9>{
			name = "927th Fighter Air Base",
			nativeName = "927th Fighter Air Base",
			picture = "Belarus/troops/927.png"
		} },
	Units = {
		ADEquipments = {
			ADEquipment = { {
	...
	WorldID = 24,
	award_by_name = {},
	flag = "FUI/Common/Flags/Belarus.png",
	flag_small = "MissionEditor/data/images/flags/Belarus.png",
	rank_by_name = {
		Captain = <table 3>,
		Colonel = <table 6>,
	...
	troop_by_name = {
		["181th Helicopter Air Base"] = <table 8>,
		["206th Assault Air Base"] = <table 7>,
		["927th Fighter Air Base"] = <table 9>
	}
}