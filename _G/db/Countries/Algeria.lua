_G["db"]["Countries"]["#Index"] = {
	Awards = { <1>{
			countryID = 70,
			name = "Medal of Military Merit",
			nativeName = "Medal of Military Merit",
			picture = "Algeria/awards/Medal of Military Merit.png",
			threshold = 200
		}, <2>{
			countryID = 70,
			name = "Medal of the National Peoples Army",
			nativeName = "Medal of the National Peoples Army",
			picture = "Algeria/awards/Medal of the National Peoples Army.png",
			threshold = 600
		}, <3>{
			countryID = 70,
			name = "Medal of the National Peoples Army  II",
			...
			picture = "Algeria/awards/Medal of Veterans of the Revolution.png",
			threshold = 2600
		} },
