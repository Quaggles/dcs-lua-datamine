_G["db"]["Countries"]["#Index"] = {
	Awards = { <1>{
			countryID = 89,
			name = "Defensor de la Patria",
			nativeName = "Defensor de la Patria",
			picture = "Peru/awards/PE-01-Defensor_de_la_Patria.png",
			threshold = 1500
		}, <2>{
			countryID = 89,
			name = "Orden Capitan Quinones",
			nativeName = "Orden Capitan Quinones",
			picture = "Peru/awards/PE-02-Orden_Capitan_Quinones.png",
			threshold = 3000
		} },
	...
	Troops = { <9>{
			name = "Peruvian AF",
			nativeName = "Fuerza Aérea del Perú",
			picture = "Peru/troops/fuerza_aerea_peru.png"
		}, <10>{
			name = "Grupo Aereo No2",
			nativeName = "Grupo Aereo No2",
			picture = "Peru/troops/FAP_GA_No2.png"
		}, <11>{
			name = "Grupo Aereo No4",
			nativeName = "Grupo Aereo No4",
			picture = "Peru/troops/FAP_GA_No4.png"
		}, <12>{
			name = "Grupo Aereo No6",
			nativeName = "Grupo Aereo No6",
			picture = "Peru/troops/FAP_GA_No6.png"
		}, <13>{
			name = "Grupo Aereo No11",
			nativeName = "Grupo Aereo No11",
			picture = "Peru/troops/FAP_GA_No11.png"
		}, <14>{
			name = "Grupo Aereo No51",
			nativeName = "Grupo Aereo No51",
			picture = "Peru/troops/FAP_GA_No51.png"
		} },
	Units = {
		ADEquipments = {
			ADEquipment = { {
	...
	WorldID = 89,
	award_by_name = {
		["Defensor de la Patria"] = <table 1>,
		["Orden Capitan Quinones"] = <table 2>
	},
	flag = "FUI/Common/Flags/Peru.png",
	flag_small = "MissionEditor/data/images/flags/Peru.png",
	rank_by_name = {
		Captain = <table 5>,
		Colonel = <table 8>,
		["First lieutenant"] = <table 4>,
		["Lieutenant colonel"] = <table 7>,
		Major = <table 6>,
		["Second lieutenant"] = <table 3>
	},
	troop_by_name = {
		["Grupo Aereo No11"] = <table 13>,
		["Grupo Aereo No2"] = <table 10>,
		["Grupo Aereo No4"] = <table 11>,
		["Grupo Aereo No51"] = <table 14>,
		["Grupo Aereo No6"] = <table 12>,
		["Peruvian AF"] = <table 9>
	}
}