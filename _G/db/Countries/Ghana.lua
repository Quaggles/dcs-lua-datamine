_G["db"]["Countries"]["#Index"] = {
	Awards = { <1>{
			countryID = 87,
			name = "Medal for Gallantry",
			nativeName = "Medal for Gallantry",
			picture = "Ghana/awards/GH-01-Medal_for_Gallantry.png",
			threshold = 800
		}, <2>{
			countryID = 87,
			name = "Grand Medal",
			nativeName = "Grand Medal",
			picture = "Ghana/awards/GH-02-Grand_Medal.png",
			threshold = 1500
		}, <3>{
			countryID = 87,
			name = "Order of the Volta",
			nativeName = "Order of the Volta",
			picture = "Ghana/awards/GH-03-Order_of_the_Volta.png",
			threshold = 2200
		}, <4>{
			countryID = 87,
			name = "Order of the Star of Ghana",
			nativeName = "Order of the Star of Ghana",
			picture = "Ghana/awards/GH-04-Order_of_the_Star_of_Ghana.png",
			threshold = 3000
		} },
	...
	Troops = { <11>{
			name = "GhanaAF",
			nativeName = "Ghana Air Force",
			picture = "Ghana/troops/ghana-air-force.png"
		} },
	Units = {
		ADEquipments = {
			ADEquipment = { {
	...
	award_by_name = {
		["Grand Medal"] = <table 2>,
		["Medal for Gallantry"] = <table 1>,
		["Order of the Star of Ghana"] = <table 4>,
		["Order of the Volta"] = <table 3>
	},
	flag = "FUI/Common/Flags/Ghana.png",
	flag_small = "MissionEditor/data/images/flags/Ghana.png",
	rank_by_name = {
		Captain = <table 7>,
		Colonel = <table 10>,
		["First lieutenant"] = <table 6>,
		["Lieutenant colonel"] = <table 9>,
		Major = <table 8>,
		["Second lieutenant"] = <table 5>
	},
	troop_by_name = {
		GhanaAF = <table 11>
	}
