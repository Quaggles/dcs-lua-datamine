_G["db"]["Countries"]["#Index"] = {
	Awards = { <1>{
			countryID = 88,
			name = "Forces Service Star",
			nativeName = "Forces Service Star",
			picture = "Nigeria/awards/NG-01-Forces_Service_Star.png",
			threshold = 1500
		}, <2>{
			countryID = 88,
			name = "Officer of the Order of the Niger",
			nativeName = "Officer of the Order of the_Niger",
			picture = "Nigeria/awards/NG-02-Officer_of_the_Order_of_the_Niger.png",
			threshold = 2200
		}, <3>{
			countryID = 88,
			name = "Officer of the Order of the Federal Republic",
			nativeName = "Officer of the Order of the Federal Republic",
			picture = "Nigeria/awards/NG-03-Officer_of_the_Order_of_the_Federal_Republic.png",
			threshold = 3000
		} },
	...
	Troops = { <10>{
			name = "Nigerian AF",
			nativeName = "Nigerian Air Force",
			picture = "Nigeria/troops/Nigerian_Air_Force.png"
		}, <11>{
			name = "NAF - 301 Flying Training School",
			nativeName = "NAF 301 Flying Training School",
			picture = "Nigeria/troops/Nigerian_Air_Force_301.png"
		} },
	Units = {
		ADEquipments = {
			ADEquipment = { {
	...
	WorldID = 88,
	award_by_name = {
		["Forces Service Star"] = <table 1>,
		["Officer of the Order of the Federal Republic"] = <table 3>,
		["Officer of the Order of the Niger"] = <table 2>
	},
	flag = "FUI/Common/Flags/Nigeria.png",
	flag_small = "MissionEditor/data/images/flags/Nigeria.png",
	rank_by_name = {
		Captain = <table 6>,
		Colonel = <table 9>,
	...
	troop_by_name = {
		["NAF - 301 Flying Training School"] = <table 11>,
		["Nigerian AF"] = <table 10>
	}
}