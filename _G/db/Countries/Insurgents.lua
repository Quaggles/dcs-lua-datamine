_G["db"]["Countries"]["#Index"] = {
	...
	Ranks = { <1>{
			...
			stripes = "Insurgents/stripes.png",
			threshold = 0
		}, <2>{
	...
	ShortName = "INS",
	Troops = { <7>{
			name = "Warriors of saber & star",
			nativeName = "Warriors of saber & star",
			picture = "Insurgents/troops/insurgents.png"
		} },
	Units = {
		ADEquipments = {
			ADEquipment = {}
	...
	WorldID = 17,
	award_by_name = {},
	flag = "FUI/Common/Flags/Insurgents.png",
	flag_small = "MissionEditor/data/images/flags/Insurgents.png",
	rank_by_name = {
		Captain = <table 3>,
		Colonel = <table 6>,
	...
	troop_by_name = {
		["Warriors of saber & star"] = <table 7>
	}
}