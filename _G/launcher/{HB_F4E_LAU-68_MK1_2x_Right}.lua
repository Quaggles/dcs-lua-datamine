_G["launcher"]["{HB_F4E_LAU-68_MK1_2x_Right}"] = {
	...
	Elements = { {
			...
			DrawArgs = { { 1, 1 }, { 2, 1 } },
			ShapeName = "LAU-68_MK1",
			connector_name = "BRU-42_RIGHT",
			payload_CLSID = "{LAU68_FFAR_MK1HE}"
		}, {
			DrawArgs = { { 1, 1 }, { 2, 1 } },
			ShapeName = "LAU-68_MK1",
	...
	category = 3,
	displayName = '2x LAU-68 pod - 7 x 2.75" FFAR, UnGd Rkts Mk1, HE (TER)',
	name = "{HB_F4E_LAU-68_MK1_2x_Right}",
