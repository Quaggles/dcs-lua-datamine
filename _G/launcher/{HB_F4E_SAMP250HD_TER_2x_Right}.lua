_G["launcher"]["{HB_F4E_SAMP250HD_TER_2x_Right}"] = {
	...
	category = 1,
	displayName = "2x SAMP-250 - 250KG GP Chute Retarded Bomb HD (TER)",
	name = "{HB_F4E_SAMP250HD_TER_2x_Right}",
