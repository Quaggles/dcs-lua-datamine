_G["launcher"]["{CH47_AFT_M60D}"] = {
	CLSID = "{CH47_AFT_M60D}",
	Cx_pil = 0.001220703125,
	Elements = { {
			Position = { 0, 0, 0 },
			ShapeName = "CH47_Aft_M60D"
		} },
	Picture = "M60.png",
	...
	_unique_resource_name = "weapons.containers.{CH47_AFT_M60D}",
	...
	control_container_data = {
		...
		arg_z = 11,
		arg_z_ch_range = { -0.38333333333333, 0.069444444444444 },
		init_c = -0.6,
		init_state = true,
		rate_x = 0,
		rate_y = 40,
