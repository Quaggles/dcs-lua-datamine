_G["launcher"]["{AKAN_NO_TRC}"] = {
	CLSID = "{AKAN_NO_TRC}",
	Cx_pil = 0.001220703125,
	Elements = { {
			ShapeName = "AKANM55_NO_TRC"
		} },
	Picture = "AKANM55.png",
	Weight = 276,
	_file = "./CoreMods/aircraft/AJS37/Entry/Weapons.lua",
	_origin = "AJS37 AI by Heatblur Simulations",
	_unique_resource_name = "weapons.containers.{AKAN_NO_TRC}",
	attribute = { 4, 15, 46, "Redacted" },
	category = 6,
	displayName = "AKAN M/55 Gunpod, 150 rnds MINGR55-HE (no Tracer)",
	gun_mounts = { {
			_file = "./CoreMods/aircraft/AJS37/Entry/Weapons.lua",
			_origin = "AJS37 AI by Heatblur Simulations",
