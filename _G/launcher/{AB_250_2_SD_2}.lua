_G["launcher"]["{AB_250_2_SD_2}"] = {
	...
	settings = { {
			...
			defValue = 0,
			dimension = "s",
			id = "submunition_func_delay_ctrl_Z41",
			...
			defValue = 3,
			dimension = "s",
			id = "submunition_arm_delay_ctrl_Z41",
			label = "Arm Delay",
			max = 1800,
			min = 0,
			readOnly = true,
			...
			defValue = 1,
			dimension = "s",
			id = "submunition_func_delay_ctrl_Z67",
			label = "Function Delay",
			stringIndex = 5,
			values = { {
					dispName = 300,
			...
			defValue = 0,
			dimension = "s",
			id = "submunition_arm_delay_ctrl_Z67",
			label = "Arm Delay",
			max = 1800,
			min = 0,
			readOnly = true,
			...
			defValue = 0,
			dimension = "s",
			id = "submunition_func_delay_ctrl_Z70B",
			label = "Function Delay",
			max = 1800,
			min = 0,
			readOnly = true,
			...
			defValue = 5,
			dimension = "s",
			id = "submunition_arm_delay_ctrl_Z70B",
			label = "Arm Delay",
			max = 1800,
			min = 0,
			readOnly = true,
