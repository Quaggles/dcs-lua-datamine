_G["launcher"]["{MB339_DEFA553_L}"] = {
	...
	_unique_resource_name = "weapons.containers.{MB339_DEFA553_L}",
	attribute = { 4, 15, 46, "Redacted" },
	category = 6,
	displayName = "DEFA553 Gunpod Left",
	gun_mounts = { {
			aft_gun_mount = false,
			azimuth_initial = 0,
	...
	shape_table_data = { {
			file = "MB339-DEFA553_L",
			index = "Redacted",
			name = "MB339-DEFA553_L",
			username = "MB339-DEFA553_L"
		} }
}