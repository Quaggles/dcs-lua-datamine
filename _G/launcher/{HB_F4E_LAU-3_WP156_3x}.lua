_G["launcher"]["{HB_F4E_LAU-3_WP156_3x}"] = {
	CLSID = "{HB_F4E_LAU-3_WP156_3x}",
	Count = 3,
	Cx_pil = 0.00683453125,
	Elements = { {
			IsAdapter = true,
			Position = { 0, 0, 0 },
			...
			DrawArgs = { { 1, 1 }, { 2, 1 } },
			ShapeName = "LAU-3_WP156",
			connector_name = "BRU-42_RIGHT",
			payload_CLSID = "{LAU3_FFAR_WP156}"
		}, {
			DrawArgs = { { 1, 1 }, { 2, 1 } },
			ShapeName = "LAU-3_WP156",
	...
	category = 3,
	displayName = '3x LAU-3 pod - 19 x 2.75" FFAR, UnGd Rkts M156, Wht Phos (TER)',
	name = "{HB_F4E_LAU-3_WP156_3x}",
