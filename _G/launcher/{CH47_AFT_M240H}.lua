_G["launcher"]["{CH47_AFT_M240H}"] = {
	CLSID = "{CH47_AFT_M240H}",
	Cx_pil = 0.001220703125,
	Elements = { {
			Position = { 0, 0, 0 },
			ShapeName = "CH47_Aft_M240H"
		} },
	Picture = "M240.png",
	...
	_unique_resource_name = "weapons.containers.{CH47_AFT_M240H}",
	...
	control_container_data = {
		...
		arg_x_ch_range = { 0, 1 },
		arg_y = 12,
		arg_y_ch_range = { 0.26111111111111, -0.26111111111111 },
		arg_z = 11,
		arg_z_ch_range = { -0.32777777777778, 0.069444444444444 },
		init_c = -0.6,
		init_state = true,
		rate_x = 0,
		rate_y = 180,
