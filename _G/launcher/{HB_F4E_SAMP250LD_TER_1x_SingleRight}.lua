_G["launcher"]["{HB_F4E_SAMP250LD_TER_1x_SingleRight}"] = {
	...
	category = 1,
	displayName = "1x SAMP-250 - 250KG GP Bomb LD (TER)",
	name = "{HB_F4E_SAMP250LD_TER_1x_SingleRight}",
