_G["launcher"]["{MBD3_U6_5*FAB-250}"] = {
	...
	Elements = { {
			...
			Position = { -0.986493, -0.124806, 0.159743 },
			Rotation = { -40, 0, 0 },
			ShapeName = "fab-250-n1"
		}, {
			Position = { -0.986493, -0.122812, -0.160811 },
			Rotation = { 40, 0, 0 },
			ShapeName = "fab-250-n1"
		}, {
	...
	category = 1,
	displayName = "MBD3-U6-68 - 5 x OFAB-250-270 - 250 kg GP Bomb LD",
	name = "{MBD3_U6_5*FAB-250}",
	settings = { {
			baseDim = "",
			control = "comboList",
			defValue = 1,
