_G["launcher"]["{HB_F4E_CBU-2B/A}"] = {
	...
	Elements = { {
			...
			DrawArgs = { { 0, 1 } },
			ShapeName = "HB_F-4E_EXT_BLU3B_unarmed",
	...
	Picture = "suu-1a.png",
	Weight = 382.89515088,
	Weight_Empty = 54.884632,
	_file = "./CoreMods/aircraft/F-4E/Entry/Weapons.lua",
	_origin = "F-4E AI by Heatblur Simulations",
	attribute = { 4, 5, 32, "Redacted" },
	category = 1,
	displayName = "HB_F4E_CBU-2B/A pod - 19 x tubes of Bomblets BLU-3B x 22, HE",
	name = "{HB_F4E_CBU-2B/A}",
