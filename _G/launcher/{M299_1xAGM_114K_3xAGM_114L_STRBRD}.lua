_G["launcher"]["{M299_1xAGM_114K_3xAGM_114L_STRBRD}"] = {
	...
	Elements = { {
			...
			payload_CLSID = "{AGM_114L}"
		}, {
			connector_name = "Point002",
			payload_CLSID = "{ee368869-c35a-486a-afe7-284beb7c5d52}"
		}, {
	...
	category = 2,
	displayName = "M299 - 1 x AGM-114K, 3 x AGM-114L Hellfire, Starboard",
	name = "{M299_1xAGM_114K_3xAGM_114L_STRBRD}",
	shape_table_data = {},
