_G["launcher"]["{HB_F4E_LAU-10_ZUNI_2x_Opposed}"] = {
	CLSID = "{HB_F4E_LAU-10_ZUNI_2x_Opposed}",
	Count = 2,
	Cx_pil = 0.00585796875,
	Elements = { {
			IsAdapter = true,
			Position = { 0, 0, 0 },
	...
	category = 3,
	displayName = '2x LAU-10 pod - 4 x 5" Zuni, UnGd Rkts Mk71, HE/FRAG (TER) Opposed',
	name = "{HB_F4E_LAU-10_ZUNI_2x_Opposed}",
