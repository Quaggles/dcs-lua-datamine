_G["launcher"]["{HB_F4E_LAU-10_ZUNI_MER_3x}"] = {
	CLSID = "{HB_F4E_LAU-10_ZUNI_MER_3x}",
	Count = 3,
	Cx_pil = 0.007526953125,
	Elements = { {
			DrawArgs = { { 1, 0 } },
			IsAdapter = true,
			Position = { 0, 0, 0 },
	...
	category = 3,
	displayName = '3x LAU-10 pod - 4 x 5" Zuni, UnGd Rkts Mk71, HE/FRAG (MER)',
	name = "{HB_F4E_LAU-10_ZUNI_MER_3x}",
