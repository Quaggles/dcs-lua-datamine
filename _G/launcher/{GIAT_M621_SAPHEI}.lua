_G["launcher"]["{GIAT_M621_SAPHEI}"] = {
	...
	_unique_resource_name = "weapons.containers.{GIAT_M621_SAPHEI}",
	attribute = { 4, 15, 46, "Redacted" },
	category = 6,
	displayName = "GIAT M621 (240x SAPHEI)",
	gun_mounts = { {
			_file = "./CoreMods/aircraft/SA342/SA342_Weapons.lua",
			_origin = "SA342 AI by Polychop-Simulations",
			aft_gun_mount = false,
	...
	shape_table_data = { {
			...
			index = "Redacted",
			life = 1,
			name = "GIAT_M261_SAPHEI",
			username = "GIAT_M261_SAPHEI"
		} },
