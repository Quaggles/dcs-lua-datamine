_G["launcher"]["{LAU_34_AGM_45A_SWA}"] = {
	CLSID = "{LAU_34_AGM_45A_SWA}",
	Count = 1,
	Cx_pil = 0.0026845703125,
	Elements = { "_G/Pylons/HB_F-4E_LAU-34.lua", {
			Position = { 0, 0, 0 },
	...
	category = 2,
	displayName = "(Special Weapons Adapter) AGM-45A Shrike ARM (LAU-34)",
	ejectPitchRate = 0,
	ejectVelocity = 0,
	name = "{LAU_34_AGM_45A_SWA}",
	settings = { {
			baseDim = "",
			control = "comboList",
			defValue = 1,
