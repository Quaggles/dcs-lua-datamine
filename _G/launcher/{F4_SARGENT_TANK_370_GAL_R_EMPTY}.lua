_G["launcher"]["{F4_SARGENT_TANK_370_GAL_R_EMPTY}"] = {
	...
	_unique_resource_name = "weapons.droptanks.HB_F-4E_EXT_WingTank_R_EMPTY",
	attribute = { 1, 3, 43, "Redacted" },
	category = 5,
	displayName = "Sargent Fletcher Fuel Tank 370 gallons (empty)",
