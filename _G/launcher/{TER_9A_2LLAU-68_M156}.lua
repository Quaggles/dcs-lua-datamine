_G["launcher"]["{TER_9A_2L*LAU-68_M156}"] = {
	...
	category = 3,
	displayName = 'TER-9A with 2 x LAU-68 pod - 7 x 2.75" Hydra, UnGd Rkts M156, Wht Phos',
	name = "{TER_9A_2L*LAU-68_M156}",
