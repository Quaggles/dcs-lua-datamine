_G["launcher"]["{UB-16_S5M}"] = {
	...
	Elements = { "_G/Pylons/UB-16.lua", {
			...
			DrawArgs = { { 1, 1 }, { 2, 1 } },
			Position = { 0.1, -0.302, -0.065 },
			Rotation = { 0, 0, 0 },
			ShapeName = "S-5M"
		}, {
			DrawArgs = { { 1, 1 }, { 2, 1 } },
			Position = { 0.1, -0.17, 0.06 },
			Rotation = { 0, 0, 0 },
			ShapeName = "S-5M"
		}, {
			DrawArgs = { { 1, 1 }, { 2, 1 } },
