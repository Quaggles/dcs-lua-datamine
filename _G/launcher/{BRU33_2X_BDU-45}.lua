_G["launcher"]["{BRU33_2X_BDU-45}"] = {
	...
	category = 1,
	displayName = "BRU-33 with 2 x BDU-45 - 500lb Practice Bomb",
	name = "{BRU33_2X_BDU-45}",
	settings = { {
			baseDim = "",
			control = "comboList",
			defValue = "M904E4",
			...
			VisibilityCondition = { {
					...
					id = "NFP_function_delay_ctrl_FMU139CB_HD",
					value = 0.025
				} },
			baseDim = "s",
			control = "comboList",
			defValue = 2.6,
			dimension = "s",
			id = "NFP_arm_delay_ctrl_FMU139CB_HD_FD_0.025",
			label = "Arm Delay",
			nLocDim = "s",
			stringIndex = 4,
			values = { {
			...
			defValue = 2.6,
			dimension = "s",
			id = "NFP_arm_delay_ctrl_FMU139CB_HD_FD_0.01",
			label = "Arm Delay",
			max = 1000000000000,
			min = 0,
			nLocDim = "s",
			...
			defValue = 2,
			dimension = "s",
			id = "NFP_arm_delay_ctrl_FMU152AB_HD",
			label = "Arm Delay",
			nLocDim = "s",
			stringIndex = 4,
			values = { {
			...
			defValue = 2.6,
			dimension = "s",
			id = "NFP_arm_delay_ctrl_FMU139CB_HD_FD_0.06",
			label = "Arm Delay",
			max = 1000000000000,
			min = 0,
			nLocDim = "s",
			...
			defValue = 2,
			dimension = "s",
			id = "NFP_arm_delay_ctrl_FMU139CB_HD_FD_0",
			label = "Arm Delay",
			nLocDim = "s",
			stringIndex = 4,
			values = { {
			...
			defValue = 0,
			dimension = "",
			id = "NFP_function_delay_ctrl_FMU152AB_HD",
			label = "Function Delay",
			stringIndex = 4,
			values = { {
					dispName = "0 s",
