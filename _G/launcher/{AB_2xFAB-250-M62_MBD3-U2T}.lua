_G["launcher"]["{AB_2xFAB-250-M62_MBD3-U2T}"] = {
	...
	category = 1,
	displayName = "MBD3-U2T-1 with 2 x FAB-250M-62 - 250 kg GP Bomb LD",
	...
	wsTypeOfWeapon = "weapons.bombs.FAB-250-M62"
}