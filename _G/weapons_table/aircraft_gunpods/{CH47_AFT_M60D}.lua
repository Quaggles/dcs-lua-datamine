_G["weapons_table"]["aircraft_gunpods"]["{CH47_AFT_M60D}"] = {
	_unique_resource_name = "weapons.gunmounts.{CH47_AFT_M60D}",
	display_name = "{CH47_AFT_M60D}",
	gunpod_name = "{CH47_AFT_M60D}",
	mounts = { {
			aft_gun_mount = false,
			azimuth_initial = 0,
