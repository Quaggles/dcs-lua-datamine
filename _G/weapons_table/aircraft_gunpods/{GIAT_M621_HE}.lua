_G["weapons_table"]["aircraft_gunpods"]["{GIAT_M621_HE}"] = {
	_unique_resource_name = "weapons.gunmounts.{GIAT_M621_HE}",
	display_name = "{GIAT_M621_HE}",
	gunpod_name = "{GIAT_M621_HE}",
	mounts = { {
