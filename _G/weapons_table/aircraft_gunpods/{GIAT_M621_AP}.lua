_G["weapons_table"]["aircraft_gunpods"]["{GIAT_M621_AP}"] = {
	_unique_resource_name = "weapons.gunmounts.{GIAT_M621_AP}",
	display_name = "{GIAT_M621_AP}",
	gunpod_name = "{GIAT_M621_AP}",
	mounts = { {
