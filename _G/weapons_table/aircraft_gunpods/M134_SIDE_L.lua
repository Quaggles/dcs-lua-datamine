_G["weapons_table"]["aircraft_gunpods"]["M134_SIDE_L"] = {
	_unique_resource_name = "weapons.gunmounts.M134_SIDE_L",
	display_name = "M134_SIDE_L",
	gunpod_name = "M134_SIDE_L",
	mounts = { {
			aft_gun_mount = false,
			azimuth_initial = 0,
