_G["weapons_table"]["aircraft_gunpods"]["{CC420_GUN_POD}"] = {
	_unique_resource_name = "weapons.gunmounts.{CC420_GUN_POD}",
	display_name = "{CC420_GUN_POD}",
	gunpod_name = "{CC420_GUN_POD}",
	mounts = { {
			...
			muzzle_pos = { 2.213762, -0.346013, -0.000696 },
