_G["weapons_table"]["aircraft_gunpods"]["{CH47_PORT_M134D}"] = {
	_unique_resource_name = "weapons.gunmounts.{CH47_PORT_M134D}",
	display_name = "{CH47_PORT_M134D}",
	gunpod_name = "{CH47_PORT_M134D}",
	mounts = { {
			aft_gun_mount = false,
			azimuth_initial = 0,
			...
			turret = {
				...
				name = "CH47_PORT_M134D"
			}
		} },
	name = "{CH47_PORT_M134D}",
	short_name = "{CH47_PORT_M134D}",
	ws_type = "Redacted"
}