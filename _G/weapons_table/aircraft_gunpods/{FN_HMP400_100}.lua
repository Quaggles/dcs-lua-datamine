_G["weapons_table"]["aircraft_gunpods"]["{FN_HMP400_100}"] = {
	_unique_resource_name = "weapons.gunmounts.{FN_HMP400_100}",
	display_name = "{FN_HMP400_100}",
	gunpod_name = "{FN_HMP400_100}",
	mounts = { {
