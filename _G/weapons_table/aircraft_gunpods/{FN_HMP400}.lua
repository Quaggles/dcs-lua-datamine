_G["weapons_table"]["aircraft_gunpods"]["{FN_HMP400}"] = {
	_unique_resource_name = "weapons.gunmounts.{FN_HMP400}",
	display_name = "{FN_HMP400}",
	gunpod_name = "{FN_HMP400}",
	mounts = { {
