_G["weapons_table"]["aircraft_gunpods"]["OH58D_M3P_L500"] = {
	_unique_resource_name = "weapons.gunmounts.OH58D_M3P_L500",
	display_name = "OH58D_M3P_L500",
	gunpod_name = "OH58D_M3P_L500",
	mounts = { {
			_file = "./CoreMods/aircraft/OH-58D/OH58D_Weapons.lua",
			_origin = "OH58D AI by Polychop-Simulations",
			_unique_resource_name = "weapons.gunmounts.OH58D_M3P",
			aft_gun_mount = false,
			azimuth_initial = 0,
			category = 8,
