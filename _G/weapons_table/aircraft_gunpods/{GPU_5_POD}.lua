_G["weapons_table"]["aircraft_gunpods"]["{GPU_5_POD}"] = {
	_unique_resource_name = "weapons.gunmounts.{GPU_5_POD}",
	display_name = "{GPU_5_POD}",
	gunpod_name = "{GPU_5_POD}",
	mounts = { {
