_G["weapons_table"]["aircraft_gunpods"]["{CH47_STBD_M134D}"] = {
	_unique_resource_name = "weapons.gunmounts.{CH47_STBD_M134D}",
	display_name = "{CH47_STBD_M134D}",
	gunpod_name = "{CH47_STBD_M134D}",
	mounts = { {
			aft_gun_mount = false,
			azimuth_initial = 0,
