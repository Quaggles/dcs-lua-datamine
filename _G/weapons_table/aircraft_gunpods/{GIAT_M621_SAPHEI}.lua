_G["weapons_table"]["aircraft_gunpods"]["{GIAT_M621_SAPHEI}"] = {
	_unique_resource_name = "weapons.gunmounts.{GIAT_M621_SAPHEI}",
	display_name = "{GIAT_M621_SAPHEI}",
	gunpod_name = "{GIAT_M621_SAPHEI}",
	mounts = { {
	...
	name = "{GIAT_M621_SAPHEI}",
	short_name = "{GIAT_M621_SAPHEI}",
	ws_type = "Redacted"
}