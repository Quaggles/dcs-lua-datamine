_G["weapons_table"]["aircraft_gunpods"]["{MB339_DEFA553_R}"] = {
	_unique_resource_name = "weapons.gunmounts.{MB339_DEFA553_R}",
	display_name = "{MB339_DEFA553_R}",
	gunpod_name = "{MB339_DEFA553_R}",
	mounts = { {
			aft_gun_mount = false,
			azimuth_initial = 0,
	...
	name = "{MB339_DEFA553_R}",
	short_name = "{MB339_DEFA553_R}",
	ws_type = "Redacted"
}