_G["weapons_table"]["aircraft_gunpods"]["{MB339_ANM3_L}"] = {
	_unique_resource_name = "weapons.gunmounts.{MB339_ANM3_L}",
	display_name = "{MB339_ANM3_L}",
	gunpod_name = "{MB339_ANM3_L}",
	mounts = { {
			aft_gun_mount = false,
			azimuth_initial = 0,
