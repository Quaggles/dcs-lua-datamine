_G["weapons_table"]["aircraft_gunpods"]["{MB339_ANM3_R}"] = {
	_unique_resource_name = "weapons.gunmounts.{MB339_ANM3_R}",
	display_name = "{MB339_ANM3_R}",
	gunpod_name = "{MB339_ANM3_R}",
	mounts = { {
			aft_gun_mount = false,
			azimuth_initial = 0,
