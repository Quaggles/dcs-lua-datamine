_G["weapons_table"]["aircraft_gunpods"]["M134_SIDE_R"] = {
	_unique_resource_name = "weapons.gunmounts.M134_SIDE_R",
	display_name = "M134_SIDE_R",
	gunpod_name = "M134_SIDE_R",
	mounts = { {
			aft_gun_mount = false,
			azimuth_initial = 0,
