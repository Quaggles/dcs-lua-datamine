_G["weapons_table"]["aircraft_gunpods"]["{GIAT_M621_APHE}"] = {
	_unique_resource_name = "weapons.gunmounts.{GIAT_M621_APHE}",
	display_name = "{GIAT_M621_APHE}",
	gunpod_name = "{GIAT_M621_APHE}",
	mounts = { {
			_file = "./CoreMods/aircraft/SA342/SA342_Weapons.lua",
			_origin = "SA342 AI by Polychop-Simulations",
			_unique_resource_name = "weapons.gunmounts.GIAT_M261",
			aft_gun_mount = false,
			azimuth_initial = 0,
			category = 8,
