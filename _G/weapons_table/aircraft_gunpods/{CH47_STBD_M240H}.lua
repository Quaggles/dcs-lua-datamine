_G["weapons_table"]["aircraft_gunpods"]["{CH47_STBD_M240H}"] = {
	_unique_resource_name = "weapons.gunmounts.{CH47_STBD_M240H}",
	display_name = "{CH47_STBD_M240H}",
	gunpod_name = "{CH47_STBD_M240H}",
	mounts = { {
			aft_gun_mount = false,
			azimuth_initial = 0,
