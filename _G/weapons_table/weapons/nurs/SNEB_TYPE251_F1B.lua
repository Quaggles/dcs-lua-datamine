_G["weapons_table"]["weapons"]["nurs"]["SNEB_TYPE251_F1B"] = {
	_file = "./CoreMods/aircraft/AircraftWeaponPack/rockets.lua",
	_origin = "AircraftWeaponPack",
	_unique_resource_name = "weapons.nurs.SNEB_TYPE251_F1B",
	client = {
		_file = "./CoreMods/aircraft/AircraftWeaponPack/rockets.lua",
		_origin = "AircraftWeaponPack",
		category = 3,
		...
		control = {},
		displayName = "68 mm SNEB Type 251 F1B HE",
		engine = {
			boost_factor = 1,
			boost_tail = 1,
			boost_time = 0,
		...
		user_name = "SNEB Type 251 F1B HE",
		warhead = {
			caliber = 68,
	...
	display_name = "SNEB Type 251 F1B HE",
	dist_max = 4000,
	dist_min = 500,
	mass = 4.31,
	model = "sneb68_eap",
