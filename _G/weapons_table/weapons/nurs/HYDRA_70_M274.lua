_G["weapons_table"]["weapons"]["nurs"]["HYDRA_70_M274"] = {
	_file = "./CoreMods/aircraft/AircraftWeaponPack/rockets.lua",
	_origin = "AircraftWeaponPack",
	_unique_resource_name = "weapons.nurs.HYDRA_70_M274",
	client = {
		_file = "./CoreMods/aircraft/AircraftWeaponPack/rockets.lua",
		_origin = "AircraftWeaponPack",
		category = 3,
		class_name = "wAmmunitionNURS",
		displayName = "Hydra 70 M274 TP-SM",
		engine = {
			boost_factor = 1,
			boost_tail = 1,
			boost_time = 0,
		...
		shape_table_data = { {
				...
				index = "Redacted",
				name = "HYDRA_70_M274",
				username = "Hydra 70 M274 TP-SM"
			} },
		user_name = "Hydra 70 M274 TP-SM",
		warhead = {
			caliber = 70,
			color = { 1, 1, 1 },
			duration = 1,
	...
	display_name = "Hydra 70 M274 TP-SM",
	dist_max = 4000,
	dist_min = 500,
	mass = 10.4,
	model = "hydra_m156",
