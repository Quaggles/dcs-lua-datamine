_G["weapons_table"]["weapons"]["nurs"]["SNEB_TYPE257_H1"] = {
	_file = "./CoreMods/aircraft/AircraftWeaponPack/rockets.lua",
	_origin = "AircraftWeaponPack",
	_unique_resource_name = "weapons.nurs.SNEB_TYPE257_H1",
	client = {
		_file = "./CoreMods/aircraft/AircraftWeaponPack/rockets.lua",
		_origin = "AircraftWeaponPack",
		category = 3,
		...
		control = {},
		displayName = "68 mm SNEB Type 257 H1 HE/Frag Lg Whd",
		engine = {
			boost_factor = 1,
			boost_tail = 1,
			boost_time = 0,
		...
		user_name = "SNEB Type 257 H1 HE/Frag Lg Whd",
		warhead = {
			caliber = 68,
	...
	display_name = "SNEB Type 257 H1 HE/Frag Lg Whd",
	dist_max = 4000,
	dist_min = 500,
	mass = 7.88,
	model = "SA342_SNEB68",
