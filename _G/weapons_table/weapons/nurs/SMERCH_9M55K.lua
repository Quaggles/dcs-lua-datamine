_G["weapons_table"]["weapons"]["nurs"]["SMERCH_9M55K"] = {
	_unique_resource_name = "weapons.nurs.SMERCH_9M55K",
	caliber = 0.3,
	client = {
		display_name_short = "9M55K (300mm CM-AP)",
		engine = {
			boost_factor = 1,
			boost_tail = 0,
			boost_time = 0,
		...
		launcher = {
			cluster = {
				...
				display_name = "9N235 submunitions",
				mass = 0,
				model = "",
				name = "9N235 submunitions",
				server = {
					cluster = {
						I = 0.025719,
						L = 0.332,
