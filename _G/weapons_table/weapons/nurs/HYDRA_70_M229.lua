_G["weapons_table"]["weapons"]["nurs"]["HYDRA_70_M229"] = {
	_file = "./CoreMods/aircraft/AircraftWeaponPack/rockets.lua",
	_origin = "AircraftWeaponPack",
	_unique_resource_name = "weapons.nurs.HYDRA_70_M229",
	caliber = 0.07,
	client = {
		_file = "./CoreMods/aircraft/AircraftWeaponPack/rockets.lua",
		_origin = "AircraftWeaponPack",
		...
		displayName = "Hydra 70 M229 HE",
		display_name_short = "Hydra 70 M229",
		engine = {
			boost_factor = 1,
			boost_tail = 1,
			boost_time = 0,
		...
		shape_table_data = { {
				...
				index = "Redacted",
				name = "HYDRA_70_M229",
				username = "Hydra 70 M229 HE"
			} },
		user_name = "Hydra 70 M229 HE",
		warhead = {
			caliber = 70,
