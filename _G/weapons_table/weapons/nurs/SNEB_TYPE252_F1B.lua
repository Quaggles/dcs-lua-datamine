_G["weapons_table"]["weapons"]["nurs"]["SNEB_TYPE252_F1B"] = {
	_file = "./CoreMods/aircraft/AircraftWeaponPack/rockets.lua",
	_origin = "AircraftWeaponPack",
	_unique_resource_name = "weapons.nurs.SNEB_TYPE252_F1B",
	client = {
		_file = "./CoreMods/aircraft/AircraftWeaponPack/rockets.lua",
		_origin = "AircraftWeaponPack",
		category = 3,
		...
		control = {},
		displayName = "68 mm SNEB Type 252 F1B TP",
		engine = {
			boost_factor = 1,
			boost_tail = 1,
			boost_time = 0,
		...
		user_name = "SNEB Type 252 F1B TP",
		warhead = {
			caliber = 68,
	...
	display_name = "SNEB Type 252 F1B TP",
	dist_max = 4000,
	dist_min = 500,
	mass = 4.38,
	model = "SA342_SNEB68",
