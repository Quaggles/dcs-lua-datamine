_G["weapons_table"]["weapons"]["nurs"]["AGR_20_M282_unguided"] = {
	_file = "./CoreMods/aircraft/AircraftWeaponPack/rockets.lua",
	_origin = "AircraftWeaponPack",
	_unique_resource_name = "weapons.nurs.AGR_20_M282_unguided",
	caliber = 0.07,
	client = {
		_file = "./CoreMods/aircraft/AircraftWeaponPack/rockets.lua",
		_origin = "AircraftWeaponPack",
		...
		shape_table_data = { {
				...
				life = 1,
				name = "AGR_20_M282_unguided",
				username = "APKWS M282 unguided"
			} },
		user_name = "APKWS M282 unguided",
		warhead = {
			caliber = 70,
