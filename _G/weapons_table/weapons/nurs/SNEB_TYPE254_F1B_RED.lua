_G["weapons_table"]["weapons"]["nurs"]["SNEB_TYPE254_F1B_RED"] = {
	_file = "./CoreMods/aircraft/AircraftWeaponPack/rockets.lua",
	_origin = "AircraftWeaponPack",
	_unique_resource_name = "weapons.nurs.SNEB_TYPE254_F1B_RED",
	client = {
		_file = "./CoreMods/aircraft/AircraftWeaponPack/rockets.lua",
		_origin = "AircraftWeaponPack",
		category = 3,
		class_name = "wAmmunitionNURS",
		displayName = "68 mm SNEB Type 254 F1B SM Red",
		engine = {
			boost_factor = 1,
			boost_tail = 1,
			boost_time = 0,
		...
		shape_table_data = { {
				...
				index = "Redacted",
				name = "SNEB_TYPE254_F1B_RED",
				username = "68 mm SNEB Type 254 F1B SM Red"
			} },
		user_name = "SNEB Type 254 F1B SM Red",
		warhead = {
			caliber = 68,
			color = { 1, 0, 0 },
			duration = 20,
	...
	display_name = "SNEB Type 254 F1B SM Red",
	dist_max = 4000,
	dist_min = 500,
	mass = 3.894,
	model = "SA342_SNEB68",
