_G["weapons_table"]["weapons"]["nurs"]["SNEB_TYPE256_H1"] = {
	_file = "./CoreMods/aircraft/AircraftWeaponPack/rockets.lua",
	_origin = "AircraftWeaponPack",
	_unique_resource_name = "weapons.nurs.SNEB_TYPE256_H1",
	client = {
		_file = "./CoreMods/aircraft/AircraftWeaponPack/rockets.lua",
		_origin = "AircraftWeaponPack",
		category = 3,
		...
		control = {},
		displayName = "68 mm SNEB Type 256 H1 HE/Frag",
		engine = {
			boost_factor = 1,
			boost_tail = 1,
			boost_time = 0,
		...
		user_name = "SNEB Type 256 H1 HE/Frag",
		warhead = {
			caliber = 68,
	...
	display_name = "SNEB Type 256 H1 HE/Frag",
	dist_max = 4000,
	dist_min = 500,
	mass = 6.26,
	model = "SA342_SNEB68",
