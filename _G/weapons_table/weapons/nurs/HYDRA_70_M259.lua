_G["weapons_table"]["weapons"]["nurs"]["HYDRA_70_M259"] = {
	_file = "./CoreMods/aircraft/AircraftWeaponPack/rockets.lua",
	_origin = "AircraftWeaponPack",
	_unique_resource_name = "weapons.nurs.HYDRA_70_M259",
	client = {
		_file = "./CoreMods/aircraft/AircraftWeaponPack/rockets.lua",
		_origin = "AircraftWeaponPack",
		category = 3,
		class_name = "wAmmunitionNURS",
		displayName = "Hydra 70 M259 SM",
		engine = {
			boost_factor = 1,
			boost_tail = 1,
			boost_time = 0,
		...
		shape_table_data = { {
				...
				index = "Redacted",
				name = "HYDRA_70_M259",
				username = "Hydra 70 M259 SM"
			} },
		user_name = "Hydra 70 M259 SM",
		warhead = {
			caliber = 70,
			color = { 1, 1, 1 },
			duration = 250,
