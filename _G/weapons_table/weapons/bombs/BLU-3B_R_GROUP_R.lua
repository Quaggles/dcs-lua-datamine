_G["weapons_table"]["weapons"]["bombs"]["BLU-3B_R_GROUP_R"] = {
	I = 0.09,
	L = 0.09525,
	_file = "./CoreMods/aircraft/F-100D/Entry/Weapons.lua",
	_origin = "F-100D AI by GrinnelliDesigns",
	_unique_resource_name = "weapons.bombs.BLU-3B_R_GROUP_R",
	caliber = 0.20955,
	client = {
		Ag = -1.23,
		Cx = 0,
		...
		displayName = "Bomblets - BLU-3B x 22, HE",
		fm = {
			I = 0.09,
			L = 0.09525,
			Ma = 0.03,
		...
		type = 5,
		user_name = "Bomblets - BLU-3B x 22, HE",
		wsTypeOfWeapon = { 4, 5, 38, "Redacted" }
	},
	cx = { 1, 0.29, 0.71, 0.14, 1.28 },
	display_name = "Bomblets - BLU-3B x 22, HE",
	display_name_short = "Bomblets - BLU-3B x 22, HE",
	mass = 0.78471416,
	model = "HB_F-4E_EXT_BLU3B_unarmed",
	name = "BLU-3B_R_GROUP_R",
	server = {
