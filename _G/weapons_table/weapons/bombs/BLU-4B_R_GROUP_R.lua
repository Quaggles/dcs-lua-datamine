_G["weapons_table"]["weapons"]["bombs"]["BLU-4B_R_GROUP_R"] = {
	I = 0.09,
	L = 0.124968,
	_file = "./CoreMods/aircraft/F-100D/Entry/Weapons.lua",
	_origin = "F-100D AI by GrinnelliDesigns",
	_unique_resource_name = "weapons.bombs.BLU-4B_R_GROUP_R",
	caliber = 0.210312,
	client = {
		Ag = -1.23,
		Cx = 0,
		...
		displayName = "Bomblets - BLU-4B x 27, HE",
		fm = {
			I = 0.09,
			L = 0.124968,
			Ma = 0.03,
		...
		type = 5,
		user_name = "Bomblets - BLU-4B x 27, HE",
		wsTypeOfWeapon = { 4, 5, 38, "Redacted" }
	},
	cx = { 1, 0.29, 0.71, 0.14, 1.28 },
	display_name = "Bomblets - BLU-4B x 27, HE",
	display_name_short = "Bomblets - BLU-4B x 27, HE",
	mass = 0.53523856,
	model = "HB_F-4E_EXT_BLU4B_unarmed",
	name = "BLU-4B_R_GROUP_R",
	server = {
