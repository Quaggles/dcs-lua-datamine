_G["weapons_table"]["weapons"]["bombs"]["British_GP_250LB_Bomb_Mk4"] = {
	I = 246.0375,
	L = 0.66,
	Reflection = 0.02,
	_file = "./CoreMods/WWII Units/Weapons/Weapons.lua",
	_origin = "World War II AI Units by Eagle Dynamics",
	_unique_resource_name = "weapons.bombs.British_GP_250LB_Bomb_Mk4",
	caliber = 0.259,
	client = {
		Ag = -1.23,
		Cx = 0.00133,
	...
	display_name_short = "250 lb GP Mk.IV",
	mass = 104.326,
	model = "250_lb_gp_mk_IV",
	name = "British_GP_250LB_Bomb_Mk4",
	server = {
