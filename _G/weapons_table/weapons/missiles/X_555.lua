_G["weapons_table"]["weapons"]["missiles"]["X_555"] = {
	Reflection = 0.1656,
	_file = "./CoreMods/aircraft/AircraftWeaponPack/cruise_missiles.lua",
	_origin = "AircraftWeaponPack",
	_unique_resource_name = "weapons.missiles.X_555",
	...
	client = {
		...
		scheme = "schemes/missiles/KH-555.sch",
		seeker = {
			CEP_dist_data = { 1000, 10, 2000, 20 }
		},
		shape_table_data = { {
				file = "CHAP_Kh555",
				fire = { 0, 1 },
