_G["weapons_table"]["weapons"]["missiles"]["HB-AIM-7E"] = {
	Reflection = 0.08,
	_file = "./CoreMods/aircraft/F-4E/Entry/Weapons.lua",
	_origin = "F-4E AI by Heatblur Simulations",
	_unique_resource_name = "weapons.missiles.HB-AIM-7E",
	caliber = 0.2,
	client = {
		Cx_pil = 2.21,
		D_max = 20000,
		...
		autopilot = {
			...
			Krx = 2,
			Kx = 0.1,
			PN_dist_data = { 15000, 0.5, 4000, 0.5, 2000, 1 },
			alg = 0,
			bang_bang = 0,
			delay = 2,
