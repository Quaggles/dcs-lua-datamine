_G["weapons_table"]["weapons"]["missiles"]["PL-12"] = {
	Reflection = 0.045,
	...
	client = {
		...
		M = 199,
		Mach_max = 4,
		ModelData = { 58, 0.9, 0.015, 0.05, 0.012, 0.004, 1.2, 0.9, 0.9, 0.75, 1.2, 0.5, 0, -1, -1, 6, 4, 0, 0, 1000000000, 0, 0, 9.6, 2.8, 0, 0, 0, 0, 0, 22770, 6530, 0, 0, 0, 1000000000, 100, 0, 1, 30000, 18000, 0.26, 50, 0, 1.19, 1, 2, 30000, 4, 3.2, 0.75, 70, 65000, 28000, 23000, 0.2, 0.6, 1.4, -3, 0.5 },
		Nr_max = 30,
		OmViz_max = 0.52,
