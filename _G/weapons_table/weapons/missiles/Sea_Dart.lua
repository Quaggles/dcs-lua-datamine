_G["weapons_table"]["weapons"]["missiles"]["Sea_Dart"] = {
	Reflection = 0.0182,
	_file = "./CoreMods/tech/TechWeaponPack/Database/Weapons/ammunition_missiles.lua",
	_origin = "TechWeaponPack",
	_unique_resource_name = "weapons.missiles.Sea_Dart",
	caliber = 0.42,
	client = {
		Cx_pil = 2.5,
		D_max = 56000,
		...
		scheme = "schemes/missiles/sam_semiact_ramjet.sch",
		seeker = {
			FOV = 2.0943951023932,
			aim_sigma = 10,
			ccm_k0 = 1.5,
