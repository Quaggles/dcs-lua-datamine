_G["weapons_table"]["weapons"]["missiles"]["AIM-7F_HB_copy"] = {
	Reflection = 0.08,
	_file = "./CoreMods/aircraft/F14/Entry/Weapons.lua",
	_origin = "F-14B AI by Heatblur Simulations",
	_unique_resource_name = "weapons.missiles.AIM-7F_HB_copy",
	caliber = 0.2,
	client = {
		Cx_pil = 2.21,
		D_max = 20000,
		...
		M = 231,
		Mach_max = 3.2,
		ModelData = { 58, 0.9, 0.0125, 0.052, 0.01, 0.002, 0.5, 1.2, 2.2, 1.05, 1.2, 0.18, 0, -1, -1, 3.7, 10.8, 0, 0, 1000000000, 0, 0, 10.4, 2.02, 0, 0, 0, 0, 0, 25192, 4140, 0, 0, 0, 1000000000, 75, 0, 1.5, 1000000000, 1000000000, 0, 50, 0, 1.19, 1, 2, 6800, 3.8, 30, 0.75, 43, 38000, 14500, 24000, 0.2, 0.7, 2, -3, 0.5 },
		Nr_max = 25,
		OmViz_max = 0.35,
		Range_max = 50000,
		Reflection = 0.08,
