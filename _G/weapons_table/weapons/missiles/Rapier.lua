_G["weapons_table"]["weapons"]["missiles"]["Rapier"] = {
	...
	client = {
		...
		flare = {
			...
			light_position = { { -0.86, -0.041, -0.0315 }, { -0.86, 0.041, 0.0315 } },
			particle_position = { { -0.86, -0.048, -0.02 }, { -0.86, 0.048, 0.02 }, { -0.86, -0.03, -0.04 }, { -0.86, 0.03, 0.04 } },
			smoke_color = { 0.6, 0.6, 0.6 },
			smoke_opacity = 0.05,
			smoke_position = { -2.5, 0, 0 },
			smoke_width = 0.2,
			spark_position = { { -0.86, -0.041, -0.0315 }, { -0.86, 0.041, 0.0315 } },
			start_time = 0.01
		},
		fm = {
			A = 0.6,
		...
		name = "Rapier",
		scheme = "schemes/missiles/command_guided_missile_rapier.sch",
		shape_table_data = { {
