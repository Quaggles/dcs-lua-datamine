_G["weapons_table"]["weapons"]["missiles"]["Ataka_9M120F"] = {
	Reflection = 0.03,
	_file = "./CoreMods/aircraft/AircraftWeaponPack/AS_Missiles.lua",
	_origin = "AircraftWeaponPack",
	_unique_resource_name = "weapons.missiles.Ataka_9M120F",
	caliber = 0.13,
	client = {
		Cx_pil = 0,
		D_max = 6000,
		...
		t_b = 0,
		t_marsh = 0,
		user_name = "9M120F Ataka (AT-9 Spiral-2)",
		v_mid = 300,
		v_min = 170,
		warhead = {
			caliber = 130,
			concrete_factors = { 1.28, 1.28, 1 },
			...
			fantom = 1,
			mass = 7.4,
			obj_factors = { 1.28, 1.28 },
			other_factors = { 1.28, 1.28, 1 },
			piercing_mass = 1.48,
